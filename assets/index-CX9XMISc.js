...
`,Sn=({focal:n=[.5,.5],rotation:t=[1,0],starSpeed:i=0,density:o=1.5,hueShift:l=300,disableAnimation:f=!1,speed:h=.5,glowIntensity:y=.5,saturation:d=.8,twinkleIntensity:x=.5,rotationSpeed:b=.05,transparent:P=!0,colorCycleSpeed:v=10,rainbow:g=!1,warp:R=!1,...M})=>{const D=s.useRef(null),F=s.useRef(l),w=s.useRef(null),m=s.useRef({starSpeed:i,disableAnimation:f,rainbow:g,colorCycleSpeed:v,warp:R,hueShift:l});return s.useEffect(()=>{m.current={starSpeed:i,disableAnimation:f,rainbow:g,colorCycleSpeed:v,warp:R,hueShift:l}},[i,f,g,v,R,l]),s.useEffect(()=>{if(!D.current)return;const I=D.current;I.innerHTML="";const E=new qi({alpha:P,premultipliedAlpha:!1,dpr:1}),k=E.gl;P?(k.enable(k.BLEND),k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA),k.clearColor(0,0,0,0)):k.clearColor(0,0,0,1);let O;function W(){E.setSize(I.offsetWidth*1,I.offsetHeight*1),w.current&&(w.current.uniforms.uResolution.value=new mt(k.canvas.width,k.canvas.height,k.canvas.width/k.canvas.height))}window.addEventListener("resize",W,!1),W();const C=new Wi(k);O=new Bi(k,{vertex:wn,fragment:Cn,uniforms:{uTime:{value:0},uResolution:{value:new mt(k.canvas.width,k.canvas.height,k.canvas.width/k.canvas.height)},uFocal:{value:new Float32Array(n)},uRotation:{value:new Float32Array(t)},uStarSpeed:{value:i},uDensity:{value:o},uHueShift:{value:l},uSpeed:{value:h},uGlowIntensity:{value:y},uSaturation:{value:d},uTwinkleIntensity:{value:x},uRotationSpeed:{value:b},uTransparent:{value:P}}}),w.current=O;const U=new Gi(k,{geometry:C,program:O});let L,_=0;const A=1e3/30;function a(c){if(L=requestAnimationFrame(a),!D.current||!w.current)return;const p=c-_;if(p<A)return;_=c-p%A;const{starSpeed:u,disableAnimation:j,rainbow:z,colorCycleSpeed:q,warp:K,hueShift:T}=m.current;if(!j){O.uniforms.uTime.value=c*.001;const Z=K?u*10:u;O.uniforms.uStarSpeed.value=c*.001*Z/10,z?(F.current+=q*.05,O.uniforms.uHueShift.value=F.current%360):O.uniforms.uHueShift.value=T}E.render({scene:U})}return L=requestAnimationFrame(a),I.appendChild(k.canvas),k.canvas.style.width="100%",k.canvas.style.height="100%",k.canvas.style.display="block",k.canvas.style.willChange="transform",()=>{cancelAnimationFrame(L),window.removeEventListener("resize",W),I&&k.canvas&&I.contains(k.canvas)&&I.removeChild(k.canvas),k.getExtension("WEBGL_lose_context")?.loseContext(),w.current=null}},[P]),s.useEffect(()=>{if(!w.current)return;const I=w.current.uniforms;I.uFocal.value=new Float32Array(n),I.uRotation.value=new Float32Array(t),I.uDensity.value=o,I.uSpeed.value=h,I.uGlowIntensity.value=y,I.uSaturation.value=d,I.uTwinkleIntensity.value=x,I.uRotationSpeed.value=b},[n,t,o,h,y,d,x,b]),e.jsx("div",{ref:D,className:"galaxy-container",style:{width:"100%",height:"100%",position:"absolute",top:0,left:0,contain:"strict",overflow:"hidden"},...M})},jn=st.memo(Sn);class An{#e;canvas;camera;cameraMinAspect;cameraMaxAspect;cameraFov;maxPixelRatio;minPixelRatio;scene;renderer;#i;size={width:0,height:0,wWidth:0,wHeight:0,ratio:0,pixelRatio:0};render=this.#S;onBeforeRender=()=>{};onAfterRender=()=>{};onAfterResize=()=>{};#o=!1;#n=!1;isDisposed=!1;#s;#a;#r;#l=new lt;#t={elapsed:0,delta:0};#d;constructor(t){this.#e={...t},this.#p(),this.#g(),this.#v(),this.resize(),this.#x()}#p(){this.camera=new _t,this.cameraFov=this.camera.fov}#g(){this.scene=new We}#v(){this.#e.canvas?this.canvas=this.#e.canvas:this.#e.id?this.canvas=document.getElementById(this.#e.id):console.error("Three: Missing canvas or id parameter"),this.canvas.style.display="block";const t={canvas:this.canvas,powerPreference:"high-performance",...this.#e.rendererOptions??{}};this.renderer=new Be(t),this.renderer.outputColorSpace=ai}#x(){this.#e.size instanceof Object||(window.addEventListener("resize",this.#c.bind(this)),this.#e.size==="parent"&&this.canvas.parentNode&&(this.#a=new ResizeObserver(this.#c.bind(this)),this.#a.observe(this.canvas.parentNode))),this.#s=new IntersectionObserver(this.#b.bind(this),{root:null,rootMargin:"0px",threshold:0}),this.#s.observe(this.canvas),document.addEventListener("visibilitychange",this.#f.bind(this))}#y(){window.removeEventListener("resize",this.#c.bind(this)),this.#a?.disconnect(),this.#s?.disconnect(),document.removeEventListener("visibilitychange",this.#f.bind(this))}#b(t){this.#o=t[0].isIntersecting,this.#o?this.#m():this.#u()}#f(){this.#o&&(document.hidden?this.#u():this.#m())}#c(){this.#r&&clearTimeout(this.#r),this.#r=setTimeout(this.resize.bind(this),100)}resize(){let t,i;this.#e.size instanceof Object?(t=this.#e.size.width,i=this.#e.size.height):this.#e.size==="parent"&&this.canvas.parentNode?(t=this.canvas.parentNode.offsetWidth,i=this.canvas.parentNode.offsetHeight):(t=window.innerWidth,i=window.innerHeight),this.size.width=t,this.size.height=i,this.size.ratio=t/i,this.#w(),this.#C(),this.onAfterResize(this.size)}#w(){this.camera.aspect=this.size.width/this.size.height,this.camera.isPerspectiveCamera&&this.cameraFov&&(this.cameraMinAspect&&this.camera.aspect<this.cameraMinAspect?this.#h(this.cameraMinAspect):this.cameraMaxAspect&&this.camera.aspect>this.cameraMaxAspect?this.#h(this.cameraMaxAspect):this.camera.fov=this.cameraFov),this.camera.updateProjectionMatrix(),this.updateWorldSize()}#h(t){const i=Math.tan(at.degToRad(this.cameraFov/2))/(this.camera.aspect/t);this.camera.fov=2*at.radToDeg(Math.atan(i))}updateWorldSize(){if(this.camera.isPerspectiveCamera){const t=this.camera.fov*Math.PI/180;this.size.wHeight=2*Math.tan(t/2)*this.camera.position.length(),this.size.wWidth=this.size.wHeight*this.camera.aspect}else this.camera.isOrthographicCamera&&(this.size.wHeight=this.camera.top-this.camera.bottom,this.size.wWidth=this.camera.right-this.camera.left)}#C(){this.renderer.setSize(this.size.width,this.size.height),this.#i?.setSize(this.size.width,this.size.height);let t=window.devicePixelRatio;this.maxPixelRatio&&t>this.maxPixelRatio?t=this.maxPixelRatio:this.minPixelRatio&&t<this.minPixelRatio&&(t=this.minPixelRatio),this.renderer.setPixelRatio(t),this.size.pixelRatio=t}get postprocessing(){return this.#i}set postprocessing(t){this.#i=t,this.render=t.render.bind(t)}#m(){if(this.#n)return;const t=()=>{this.#d=requestAnimationFrame(t),this.#t.delta=this.#l.getDelta(),this.#t.elapsed+=this.#t.delta,this.onBeforeRender(this.#t),this.render(),this.onAfterRender(this.#t)};this.#n=!0,this.#l.start(),t()}#u(){this.#n&&(cancelAnimationFrame(this.#d),this.#n=!1,this.#l.stop())}#S(){this.renderer.render(this.scene,this.camera)}clear(){this.scene.traverse(t=>{t.isMesh&&typeof t.material=="object"&&t.material!==null&&(Object.keys(t.material).forEach(i=>{const o=t.material[i];o!==null&&typeof o=="object"&&typeof o.dispose=="function"&&o.dispose()}),t.material.dispose(),t.geometry.dispose())}),this.scene.clear()}dispose(){this.#y(),this.#u(),this.clear(),this.#i?.dispose(),this.renderer.dispose(),this.isDisposed=!0}}const ke=new Map,je=new he;let it=!1;function kn(n){const t={position:new he,nPosition:new he,hover:!1,touching:!1,onEnter(){},onMove(){},onClick(){},onLeave(){},...n};return(function(i,o){ke.has(i)||(ke.set(i,o),it||(document.body.addEventListener("pointermove",vt),document.body.addEventListener("pointerleave",yt),document.body.addEventListener("click",xt),document.body.addEventListener("touchstart",bt,{passive:!1}),document.body.addEventListener("touchmove",wt,{passive:!1}),document.body.addEventListener("touchend",He,{passive:!1}),document.body.addEventListener("touchcancel",He,{passive:!1}),it=!0))})(n.domElement,t),t.dispose=()=>{const i=n.domElement;ke.delete(i),ke.size===0&&(document.body.removeEventListener("pointermove",vt),document.body.removeEventListener("pointerleave",yt),document.body.removeEventListener("click",xt),document.body.removeEventListener("touchstart",bt),document.body.removeEventListener("touchmove",wt),document.body.removeEventListener("touchend",He),document.body.removeEventListener("touchcancel",He),it=!1)},t}function vt(n){je.x=n.clientX,je.y=n.clientY,Pn()}function Pn(){for(const[n,t]of ke){const i=n.getBoundingClientRect();Ze(i)?($e(t,i),t.hover||(t.hover=!0,t.onEnter(t)),t.onMove(t)):t.hover&&!t.touching&&(t.hover=!1,t.onLeave(t))}}function xt(n){je.x=n.clientX,je.y=n.clientY;for(const[t,i]of ke){const o=t.getBoundingClientRect();$e(i,o),Ze(o)&&i.onClick(i)}}function yt(){for(const n of ke.values())n.hover&&(n.hover=!1,n.onLeave(n))}function bt(n){if(n.touches.length>0){n.preventDefault(),je.x=n.touches[0].clientX,je.y=n.touches[0].clientY;for(const[t,i]of ke){const o=t.getBoundingClientRect();Ze(o)&&(i.touching=!0,$e(i,o),i.hover||(i.hover=!0,i.onEnter(i)),i.onMove(i))}}}function wt(n){if(n.touches.length>0){n.preventDefault(),je.x=n.touches[0].clientX,je.y=n.touches[0].clientY;for(const[t,i]of ke){const o=t.getBoundingClientRect();$e(i,o),Ze(o)?(i.hover||(i.hover=!0,i.touching=!0,i.onEnter(i)),i.onMove(i)):i.hover&&i.touching&&i.onMove(i)}}}function He(){for(const[,n]of ke)n.touching&&(n.touching=!1,n.hover&&(n.hover=!1,n.onLeave(n)))}function $e(n,t){const{position:i,nPosition:o}=n;i.x=je.x-t.left,i.y=je.y-t.top,o.x=i.x/t.width*2-1,o.y=-i.y/t.height*2+1}function Ze(n){const{x:t,y:i}=je,{left:o,top:l,width:f,height:h}=n;return t>=o&&t<=o+f&&i>=l&&i<=l+h}const{randFloat:Rn,randFloatSpread:nt}=at,ot=new H,de=new H,Ye=new H,Ln=new H,fe=new H,Ve=new H,Ee=new H,Me=new H,Xe=new H,Ct=new H;class In{constructor(t){this.config=t,this.positionData=new Float32Array(3*t.count).fill(0),this.velocityData=new Float32Array(3*t.count).fill(0),this.sizeData=new Float32Array(t.count).fill(1),this.center=new H,this.#e(),this.setSizes()}#e(){const{config:t,positionData:i}=this;this.center.toArray(i,0);for(let o=1;o<t.count;o++){const l=3*o;i[l]=nt(2*t.maxX),i[l+1]=nt(2*t.maxY),i[l+2]=nt(2*t.maxZ)}}setSizes(){const{config:t,sizeData:i}=this;i[0]=t.size0;for(let o=1;o<t.count;o++)i[o]=Rn(t.minSize,t.maxSize)}update(t){const{config:i,center:o,positionData:l,sizeData:f,velocityData:h}=this;let y=0;i.controlSphere0&&(y=1,ot.fromArray(l,0),ot.lerp(o,.1).toArray(l,0),Ln.set(0,0,0).toArray(h,0));for(let d=y;d<i.count;d++){const x=3*d;de.fromArray(l,x),fe.fromArray(h,x),fe.y-=t.delta*i.gravity*f[d],fe.multiplyScalar(i.friction),fe.clampLength(0,i.maxVelocity),de.add(fe),de.toArray(l,x),fe.toArray(h,x)}for(let d=y;d<i.count;d++){const x=3*d;de.fromArray(l,x),fe.fromArray(h,x);const b=f[d];for(let v=d+1;v<i.count;v++){const g=3*v;Ye.fromArray(l,g),Ve.fromArray(h,g);const R=f[v];Ee.copy(Ye).sub(de);const M=Ee.length(),D=b+R;if(M<D){const F=D-M;Me.copy(Ee).normalize().multiplyScalar(.5*F),Xe.copy(Me).multiplyScalar(Math.max(fe.length(),1)),Ct.copy(Me).multiplyScalar(Math.max(Ve.length(),1)),de.sub(Me),fe.sub(Xe),de.toArray(l,x),fe.toArray(h,x),Ye.add(Me),Ve.add(Ct),Ye.toArray(l,g),Ve.toArray(h,g)}}if(i.controlSphere0){Ee.copy(ot).sub(de);const v=Ee.length(),g=b+f[0];if(v<g){const R=g-v;Me.copy(Ee.normalize()).multiplyScalar(R),Xe.copy(Me).multiplyScalar(Math.max(fe.length(),1)),de.sub(Me),fe.sub(Xe)}}Math.abs(de.x)+b>i.maxX&&(de.x=Math.sign(de.x)*(i.maxX-b),fe.x=-fe.x*i.wallBounce),i.gravity===0?Math.abs(de.y)+b>i.maxY&&(de.y=Math.sign(de.y)*(i.maxY-b),fe.y=-fe.y*i.wallBounce):de.y-b<-i.maxY&&(de.y=-i.maxY+b,fe.y=-fe.y*i.wallBounce);const P=Math.max(i.maxZ,i.maxSize);Math.abs(de.z)+b>P&&(de.z=Math.sign(de.z)*(i.maxZ-b),fe.z=-fe.z*i.wallBounce),de.toArray(l,x),fe.toArray(h,x)}}explode(t,i=2){const{positionData:o,velocityData:l,config:f}=this;for(let h=0;h<f.count;h++){const y=3*h,d=o[y]-t.x,x=o[y+1]-t.y,b=o[y+2]-t.z,P=d*d+x*x+b*b;if(P<60){const v=Math.sqrt(P)+.01,g=i*50/(v+1),R=(Math.random()-.5)*1.5,M=(Math.random()-.5)*1.5,D=(Math.random()-.5)*1.5;l[y]+=(d/v+R)*g,l[y+1]+=(x/v+M)*g,l[y+2]+=(b/v+D)*g}}}}class Mn extends hi{constructor(t){super(t),this.uniforms={thicknessDistortion:{value:.1},thicknessAmbient:{value:0},thicknessAttenuation:{value:.1},thicknessPower:{value:2},thicknessScale:{value:10}},this.defines.USE_UV="",this.onBeforeCompile=i=>{Object.assign(i.uniforms,this.uniforms),i.fragmentShader=`
      ...
      `);const o=Ce.lights_fragment_begin.replaceAll("RE_Direct( directLight, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );",`
        ...
        `);i.fragmentShader=i.fragmentShader.replace("#include <lights_fragment_begin>",o),this.onBeforeCompile2&&this.onBeforeCompile2(i)}}}const Fn={count:200,colors:[0,0,0],ambientColor:16777215,ambientIntensity:1,lightIntensity:200,materialParams:{metalness:.5,roughness:.5,clearcoat:1,clearcoatRoughness:.15},minSize:.5,maxSize:1,size0:1,gravity:.5,friction:.9975,wallBounce:.95,maxVelocity:.15,maxX:5,maxY:5,maxZ:2,controlSphere0:!1,followCursor:!0,enableExplosion:!1,rainbow:!1},Te=new ii;class _n extends ri{constructor(t,i={}){const o={...Fn,...i},l=new li,f=new ci(t,.04).fromScene(l).texture,h=new ui,y=new Mn({envMap:f,...o.materialParams});y.envMapRotation.x=-Math.PI/2,super(h,y,o.count),this.config=o,this.physics=new In(o),this.#e(),this.setColors(o.colors),this.rainbowHue=0}#e(){this.ambientLight=new di(this.config.ambientColor,this.config.ambientIntensity),this.add(this.ambientLight),this.light=new fi(this.config.colors[0],this.config.lightIntensity),this.add(this.light)}setColors(t){if(Array.isArray(t)&&t.length>1){const i=(function(o){let l,f;function h(y){l=y,f=[],l.forEach(d=>{f.push(new we(d))})}return h(o),{setColors:h,getColorAt:function(y,d=new we){const x=Math.max(0,Math.min(1,y))*(l.length-1),b=Math.floor(x),P=f[b];if(b>=l.length-1)return P.clone();const v=x-b,g=f[b+1];return d.r=P.r+v*(g.r-P.r),d.g=P.g+v*(g.g-P.g),d.b=P.b+v*(g.b-P.b),d}}})(t);for(let o=0;o<this.count;o++)this.setColorAt(o,i.getColorAt(o/this.count)),o===0&&this.light.color.copy(i.getColorAt(o/this.count));this.instanceColor.needsUpdate=!0}}update(t){if(this.physics.update(t),this.config.rainbow){this.rainbowHue+=t.delta*.2,this.light.color.setHSL(this.rainbowHue%1,1,.5);for(let i=0;i<this.count;i++){const o=(this.rainbowHue+i*.05)%1,l=new we().setHSL(o,.9,.6);this.setColorAt(i,l)}this.instanceColor.needsUpdate=!0}for(let i=0;i<this.count;i++)Te.position.fromArray(this.physics.positionData,3*i),i===0&&this.config.followCursor===!1?Te.scale.setScalar(0):Te.scale.setScalar(this.physics.sizeData[i]),Te.updateMatrix(),this.setMatrixAt(i,Te.matrix),i===0&&this.light.position.copy(Te.position);this.instanceMatrix.needsUpdate=!0}}function En(n,t={}){const i=new An({canvas:n,size:"parent",rendererOptions:{antialias:!0,alpha:!0}});let o;i.renderer.toneMapping=ni,i.camera.position.set(0,0,20),i.camera.lookAt(0,0,0),i.cameraMaxAspect=1.5,i.resize(),x(t);const l=new oi,f=new si(new H(0,0,1),0),h=new H;let y=!1;n.style.touchAction="none",n.style.userSelect="none",n.style.webkitUserSelect="none";const d=kn({domElement:n,onMove(){l.setFromCamera(d.nPosition,i.camera),i.camera.getWorldDirection(f.normal),l.ray.intersectPlane(f,h),o.physics.center.copy(h),o.config.controlSphere0=!0},onClick(){o&&o.config.enableExplosion&&o.physics.explode(o.physics.center)},onLeave(){o.config.controlSphere0=!1}});function x(b){o&&(i.clear(),i.scene.remove(o)),o=new _n(i.renderer,b),i.scene.add(o)}return i.onBeforeRender=b=>{y||o.update(b)},i.onAfterResize=b=>{o.config.maxX=b.wWidth/2,o.config.maxY=b.wHeight/2},{three:i,get spheres(){return o},setCount(b){x({...o.config,count:b})},togglePause(){y=!y},dispose(){d.dispose(),i.dispose()}}}const Tn=({className:n="",followCursor:t=!0,count:i=100,gravity:o=.5,friction:l=.9975,wallBounce:f=.95,colors:h=[0,0,0],enableExplosion:y=!1,rainbow:d=!1,...x})=>{const b=s.useRef(null),P=s.useRef(null);return s.useEffect(()=>{const v=b.current;if(v)return P.current=En(v,{followCursor:t,count:i,gravity:o,friction:l,wallBounce:f,colors:h,enableExplosion:y,rainbow:d,...x}),()=>{P.current&&P.current.dispose()}},[]),s.useEffect(()=>{const v=P.current;if(!v||!v.spheres)return;const g=v.spheres.config;g.gravity=o,g.friction=l,g.wallBounce=f,g.followCursor=t,g.enableExplosion=y,g.rainbow=d,v.spheres.setColors(h)},[o,l,f,t,h,y,d]),s.useEffect(()=>{const v=P.current;v&&v.setCount(i)},[i]),e.jsx("canvas",{className:n,ref:b,style:{width:"100%",height:"100%"}})},Dn=`
precision highp float;
...
`,Je=8;function St(n){let t=n.trim();t.startsWith("#")&&(t=t.slice(1));let i=255,o=255,l=255;return t.length===3?(i=parseInt(t[0]+t[0],16),o=parseInt(t[1]+t[1],16),l=parseInt(t[2]+t[2],16)):t.length===6&&(i=parseInt(t.slice(0,2),16),o=parseInt(t.slice(2,4),16),l=parseInt(t.slice(4,6),16)),new H(i/255,o/255,l/255)}function Nn({linesGradient:n,enabledWaves:t=["top","middle","bottom"],lineCount:i=[6],lineDistance:o=[5],topWavePosition:l,middleWavePosition:f,bottomWavePosition:h={x:2,y:-.7,rotate:-1},animationSpeed:y=1,interactive:d=!1,bendRadius:x=5,bendStrength:b=-.5,mouseDamping:P=.05,mixBlendMode:v="screen",amplitude:g=1,rainbow:R=!1}){const M=s.useRef(null),D=s.useRef(null),F=s.useRef(null),w=s.useRef(new he(-1e3,-1e3)),m=s.useRef(new he(-1e3,-1e3)),I=s.useRef(0),E=s.useRef(0),k=s.useRef(R),O=s.useRef(d);s.useEffect(()=>{O.current=d},[d]),s.useEffect(()=>{k.current=R},[R]);const W=c=>{if(typeof i=="number")return i;if(!t.includes(c))return 0;const p=t.indexOf(c);return i[p]??6},C=c=>{if(typeof o=="number")return o;if(!t.includes(c))return .1;const p=t.indexOf(c);return o[p]??.1},U=t.includes("top")?W("top"):0,L=t.includes("middle")?W("middle"):0,_=t.includes("bottom")?W("bottom"):0,Y=t.includes("top")?C("top")*.01:.01,A=t.includes("middle")?C("middle")*.01:.01,a=t.includes("bottom")?C("bottom")*.01:.01;return s.useEffect(()=>{if(F.current&&n&&n.length>0&&!R){const c=n.slice(0,Je);F.current.uniforms.lineGradientCount.value=c.length,c.forEach((p,u)=>{const j=St(p);F.current.uniforms.lineGradient.value[u].set(j.x,j.y,j.z)})}},[n,R]),s.useEffect(()=>{if(!F.current)return;const c=F.current.uniforms;c.animationSpeed.value=y,c.amplitude.value=g,c.bendRadius.value=x,c.bendStrength.value=b,c.interactive.value=d,c.enableTop.value=t.includes("top"),c.enableMiddle.value=t.includes("middle"),c.enableBottom.value=t.includes("bottom");const p=j=>{if(typeof i=="number")return i;if(!t.includes(j))return 0;const z=t.indexOf(j);return i[z]??6},u=j=>{if(typeof o=="number")return o;if(!t.includes(j))return .1;const z=t.indexOf(j);return o[z]??.1};c.topLineCount.value=t.includes("top")?p("top"):0,c.middleLineCount.value=t.includes("middle")?p("middle"):0,c.bottomLineCount.value=t.includes("bottom")?p("bottom"):0,c.topLineDistance.value=t.includes("top")?u("top")*.01:.01,c.middleLineDistance.value=t.includes("middle")?u("middle")*.01:.01,c.bottomLineDistance.value=t.includes("bottom")?u("bottom")*.01:.01},[y,g,x,b,d,t,i,o]),s.useEffect(()=>{if(!M.current)return;const c=new We,p=new ct(-1,1,1,-1,0,1);p.position.z=1;const u=new Be({antialias:!0,alpha:!1});u.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),u.domElement.style.width="100%",u.domElement.style.height="100%",M.current.appendChild(u.domElement),D.current=u;const j={iTime:{value:0},iResolution:{value:new H(1,1,1)},animationSpeed:{value:y},amplitude:{value:g},enableTop:{value:t.includes("top")},enableMiddle:{value:t.includes("middle")},enableBottom:{value:t.includes("bottom")},topLineCount:{value:U},middleLineCount:{value:L},bottomLineCount:{value:_},topLineDistance:{value:Y},middleLineDistance:{value:A},bottomLineDistance:{value:a},topWavePosition:{value:new H(l?.x??10,l?.y??.5,l?.rotate??-.4)},middleWavePosition:{value:new H(f?.x??5,f?.y??0,f?.rotate??.2)},bottomWavePosition:{value:new H(h?.x??2,h?.y??-.7,h?.rotate??.4)},iMouse:{value:new he(-1e3,-1e3)},interactive:{value:d},bendRadius:{value:x},bendStrength:{value:b},bendInfluence:{value:0},lineGradient:{value:Array.from({length:Je},()=>new H(1,1,1))},lineGradientCount:{value:0}};if(n&&n.length>0){const X=n.slice(0,Je);j.lineGradientCount.value=X.length,X.forEach((se,ae)=>{const ce=St(se);j.lineGradient.value[ae].set(ce.x,ce.y,ce.z)})}const z=new De({uniforms:j,vertexShader:Dn,fragmentShader:zn});F.current=z;const q=new Oe(2,2),K=new ze(q,z);c.add(K);const T=new lt,Z=()=>{const X=M.current,se=X.clientWidth||1,ae=X.clientHeight||1;u.setSize(se,ae,!1);const ce=u.domElement.width,pe=u.domElement.height;j.iResolution.value.set(ce,pe,1)};Z();const oe=typeof ResizeObserver<"u"?new ResizeObserver(Z):null;oe&&M.current&&oe.observe(M.current);const ee=X=>{if(!O.current)return;const se=u.domElement.getBoundingClientRect(),ae=X.clientX-se.left,ce=X.clientY-se.top,pe=u.getPixelRatio();w.current.set(ae*pe,(se.height-ce)*pe),I.current=1};window.addEventListener("pointermove",ee);let te=0;const le=()=>{if(j.iTime.value=T.getElapsedTime(),O.current&&(m.current.lerp(w.current,P),j.iMouse.value.copy(m.current),E.current+=(I.current-E.current)*P,j.bendInfluence.value=E.current),k.current){const X=T.getElapsedTime();j.lineGradientCount.value<3&&(j.lineGradientCount.value=3);for(let se=0;se<Je;se++){const ae=(X*.1+se*.15)%1,ce=new we().setHSL(ae,.8,.5);j.lineGradient.value[se].set(ce.r,ce.g,ce.b)}}u.render(c,p),te=requestAnimationFrame(le)};return le(),()=>{cancelAnimationFrame(te),oe&&M.current&&oe.disconnect(),window.removeEventListener("pointermove",ee),q.dispose(),z.dispose(),u.dispose(),u.domElement.parentElement&&u.domElement.parentElement.removeChild(u.domElement)}},[]),e.jsx("div",{ref:M,className:"floating-lines-container",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden",mixBlendMode:v}})}const Un=({topColor:n="#5227FF",bottomColor:t="#FF9FFC",intensity:i=1,rotationSpeed:o=.3,interactive:l=!1,className:f="",glowAmount:h=.005,pillarWidth:y=3,pillarHeight:d=.4,noiseIntensity:x=.5,mixBlendMode:b="screen",pillarRotation:P=0,quality:v="high"})=>{const g=s.useRef(null),R=s.useRef(null),M=s.useRef(null),D=s.useRef(null),F=s.useRef(null),w=s.useRef(null),m=s.useRef(null),I=s.useRef(new he(0,0)),E=s.useRef(0),[k,O]=s.useState(!0);return s.useEffect(()=>{const W=document.createElement("canvas");W.getContext("webgl")||W.getContext("experimental-webgl")||O(!1)},[]),s.useEffect(()=>{if(!g.current||!k)return;const W=g.current,C=W.clientWidth,U=W.clientHeight,L=new We;F.current=L;const _=new ct(-1,1,1,-1,0,1);w.current=_;const Y=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),A=Y||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<=4;let a=v;A&&v==="high"&&(a="medium"),Y&&v!=="low"&&(a="low");const c={low:{iterations:24,waveIterations:1,pixelRatio:.5,precision:"mediump",stepMultiplier:1.5},medium:{iterations:40,waveIterations:2,pixelRatio:.65,precision:"mediump",stepMultiplier:1.2},high:{iterations:80,waveIterations:4,pixelRatio:Math.min(window.devicePixelRatio,2),precision:"highp",stepMultiplier:1}},p=c[a]||c.medium;let u;try{u=new Be({antialias:!1,alpha:!0,powerPreference:a==="high"?"high-performance":"low-power",precision:p.precision,stencil:!1,depth:!1})}catch{O(!1);return}u.setSize(C,U),u.setPixelRatio(p.pixelRatio),g.current.appendChild(u.domElement),M.current=u;const j=B=>{const Q=new we(B);return new H(Q.r,Q.g,Q.b)},z=`
    ...
    `,K=P*Math.PI/180,T=Math.sin(.4),Z=Math.cos(.4),oe=new De({vertexShader:z,fragmentShader:q,uniforms:{uTime:{value:0},uResolution:{value:new he(C,U)},uMouse:{value:I.current},uTopColor:{value:j(n)},uBottomColor:{value:j(t)},uIntensity:{value:i},uInteractive:{value:l},uGlowAmount:{value:h},uPillarWidth:{value:y},uPillarHeight:{value:d},uNoiseIntensity:{value:x},uRotCos:{value:1},uRotSin:{value:0},uPillarRotCos:{value:Math.cos(K)},uPillarRotSin:{value:Math.sin(K)},uWaveSin:{value:T},uWaveCos:{value:Z}},transparent:!0,depthWrite:!1,depthTest:!1});D.current=oe;const ee=new Oe(2,2);m.current=ee;const te=new ze(ee,oe);L.add(te);let le=null;const X=B=>{if(!l||le)return;le=window.setTimeout(()=>{le=null},16);const Q=W.getBoundingClientRect(),G=(B.clientX-Q.left)/Q.width*2-1,$=-((B.clientY-Q.top)/Q.height)*2+1;I.current.set(G,$)};l&&W.addEventListener("mousemove",X,{passive:!0});let se=performance.now();const ce=1e3/(a==="low"?30:60),pe=B=>{if(!D.current||!M.current||!F.current||!w.current)return;const Q=B-se;if(Q>=ce){E.current+=.016*o;const G=E.current;D.current.uniforms.uTime.value=G,D.current.uniforms.uRotCos.value=Math.cos(G*.3),D.current.uniforms.uRotSin.value=Math.sin(G*.3),M.current.render(F.current,w.current),se=B-Q%ce}R.current=requestAnimationFrame(pe)};R.current=requestAnimationFrame(pe);let S=null;const N=()=>{S&&clearTimeout(S),S=window.setTimeout(()=>{if(!M.current||!D.current||!g.current)return;const B=g.current.clientWidth,Q=g.current.clientHeight;M.current.setSize(B,Q),D.current.uniforms.uResolution.value.set(B,Q)},150)};return window.addEventListener("resize",N,{passive:!0}),()=>{window.removeEventListener("resize",N),l&&W.removeEventListener("mousemove",X),R.current&&cancelAnimationFrame(R.current),M.current&&(M.current.dispose(),M.current.forceContextLoss(),W.contains(M.current.domElement)&&W.removeChild(M.current.domElement)),D.current&&D.current.dispose(),m.current&&m.current.dispose(),M.current=null,D.current=null,F.current=null,w.current=null,m.current=null,R.current=null}},[n,t,i,o,l,h,y,d,x,P,k,v]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        ...
        `}),k?e.jsx("div",{ref:g,className:`light-pillar-container ${f}`,style:{mixBlendMode:b}}):e.jsx("div",{className:`light-pillar-fallback ${f}`,style:{mixBlendMode:b},children:"WebGL not supported"})]})},On=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,qn=`
