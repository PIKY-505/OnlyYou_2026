...
`,ht=8;function ti(n){let t=n.trim();t.startsWith("#")&&(t=t.slice(1));let i=255,s=255,u=255;return t.length===3?(i=parseInt(t[0]+t[0],16),s=parseInt(t[1]+t[1],16),u=parseInt(t[2]+t[2],16)):t.length===6&&(i=parseInt(t.slice(0,2),16),s=parseInt(t.slice(2,4),16),u=parseInt(t.slice(4,6),16)),new se(i/255,s/255,u/255)}function bs({linesGradient:n,enabledWaves:t=["top","middle","bottom"],lineCount:i=[6],lineDistance:s=[5],topWavePosition:u,middleWavePosition:h,bottomWavePosition:S={x:2,y:-.7,rotate:-1},animationSpeed:C=1,interactive:y=!1,bendRadius:j=5,bendStrength:v=-.5,mouseDamping:P=.05,mixBlendMode:b="screen",amplitude:R=1,rainbow:k=!1}){const I=l.useRef(null),E=l.useRef(null),T=l.useRef(null),N=l.useRef(new Le(-1e3,-1e3)),U=l.useRef(new Le(-1e3,-1e3)),F=l.useRef(0),o=l.useRef(0),D=l.useRef(k),K=l.useRef(y);l.useEffect(()=>{K.current=y},[y]),l.useEffect(()=>{D.current=k},[k]);const H=a=>{if(typeof i=="number")return i;if(!t.includes(a))return 0;const p=t.indexOf(a);return i[p]??6},A=a=>{if(typeof s=="number")return s;if(!t.includes(a))return .1;const p=t.indexOf(a);return s[p]??.1},V=t.includes("top")?H("top"):0,M=t.includes("middle")?H("middle"):0,q=t.includes("bottom")?H("bottom"):0,W=t.includes("top")?A("top")*.01:.01,d=t.includes("middle")?A("middle")*.01:.01,c=t.includes("bottom")?A("bottom")*.01:.01;return l.useEffect(()=>{if(T.current&&n&&n.length>0&&!k){const a=n.slice(0,ht);T.current.uniforms.lineGradientCount.value=a.length,a.forEach((p,m)=>{const w=ti(p);T.current.uniforms.lineGradient.value[m].set(w.x,w.y,w.z)})}},[n,k]),l.useEffect(()=>{if(!T.current)return;const a=T.current.uniforms;a.animationSpeed.value=C,a.amplitude.value=R,a.bendRadius.value=j,a.bendStrength.value=v,a.interactive.value=y,a.enableTop.value=t.includes("top"),a.enableMiddle.value=t.includes("middle"),a.enableBottom.value=t.includes("bottom");const p=w=>{if(typeof i=="number")return i;if(!t.includes(w))return 0;const B=t.indexOf(w);return i[B]??6},m=w=>{if(typeof s=="number")return s;if(!t.includes(w))return .1;const B=t.indexOf(w);return s[B]??.1};a.topLineCount.value=t.includes("top")?p("top"):0,a.middleLineCount.value=t.includes("middle")?p("middle"):0,a.bottomLineCount.value=t.includes("bottom")?p("bottom"):0,a.topLineDistance.value=t.includes("top")?m("top")*.01:.01,a.middleLineDistance.value=t.includes("middle")?m("middle")*.01:.01,a.bottomLineDistance.value=t.includes("bottom")?m("bottom")*.01:.01},[C,R,j,v,y,t,i,s]),l.useEffect(()=>{if(!I.current)return;const a=new at,p=new _t(-1,1,1,-1,0,1);p.position.z=1;const m=new lt({antialias:!0,alpha:!1});m.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),m.domElement.style.width="100%",m.domElement.style.height="100%",I.current.appendChild(m.domElement),E.current=m;const w={iTime:{value:0},iResolution:{value:new se(1,1,1)},animationSpeed:{value:C},amplitude:{value:R},enableTop:{value:t.includes("top")},enableMiddle:{value:t.includes("middle")},enableBottom:{value:t.includes("bottom")},topLineCount:{value:V},middleLineCount:{value:M},bottomLineCount:{value:q},topLineDistance:{value:W},middleLineDistance:{value:d},bottomLineDistance:{value:c},topWavePosition:{value:new se(u?.x??10,u?.y??.5,u?.rotate??-.4)},middleWavePosition:{value:new se(h?.x??5,h?.y??0,h?.rotate??.2)},bottomWavePosition:{value:new se(S?.x??2,S?.y??-.7,S?.rotate??.4)},iMouse:{value:new Le(-1e3,-1e3)},interactive:{value:y},bendRadius:{value:j},bendStrength:{value:v},bendInfluence:{value:0},lineGradient:{value:Array.from({length:ht},()=>new se(1,1,1))},lineGradientCount:{value:0}};if(n&&n.length>0){const z=n.slice(0,ht);w.lineGradientCount.value=z.length,z.forEach((oe,ve)=>{const ae=ti(oe);w.lineGradient.value[ve].set(ae.x,ae.y,ae.z)})}const B=new Ze({uniforms:w,vertexShader:xs,fragmentShader:ys});T.current=B;const Y=new st(2,2),re=new et(Y,B);a.add(re);const $=new Tt,ie=()=>{const z=I.current,oe=z.clientWidth||1,ve=z.clientHeight||1;m.setSize(oe,ve,!1);const ae=m.domElement.width,xe=m.domElement.height;w.iResolution.value.set(ae,xe,1)};ie();const ne=typeof ResizeObserver<"u"?new ResizeObserver(ie):null;ne&&I.current&&ne.observe(I.current);const O=z=>{if(!K.current)return;const oe=m.domElement.getBoundingClientRect(),ve=z.clientX-oe.left,ae=z.clientY-oe.top,xe=m.getPixelRatio();N.current.set(ve*xe,(oe.height-ae)*xe),F.current=1};window.addEventListener("pointermove",O);let ee=0;const le=()=>{if(w.iTime.value=$.getElapsedTime(),K.current&&(U.current.lerp(N.current,P),w.iMouse.value.copy(U.current),o.current+=(F.current-o.current)*P,w.bendInfluence.value=o.current),D.current){const z=$.getElapsedTime();w.lineGradientCount.value<3&&(w.lineGradientCount.value=3);for(let oe=0;oe<ht;oe++){const ve=(z*.1+oe*.15)%1,ae=new Fe().setHSL(ve,.8,.5);w.lineGradient.value[oe].set(ae.r,ae.g,ae.b)}}m.render(a,p),ee=requestAnimationFrame(le)};return le(),()=>{cancelAnimationFrame(ee),ne&&I.current&&ne.disconnect(),window.removeEventListener("pointermove",O),Y.dispose(),B.dispose(),m.dispose(),m.domElement.parentElement&&m.domElement.parentElement.removeChild(m.domElement)}},[]),e.jsx("div",{ref:I,className:"floating-lines-container",style:{width:"100%",height:"100%",position:"relative",overflow:"hidden",mixBlendMode:b}})}const ws=({topColor:n="#5227FF",bottomColor:t="#FF9FFC",intensity:i=1,rotationSpeed:s=.3,interactive:u=!1,className:h="",glowAmount:S=.005,pillarWidth:C=3,pillarHeight:y=.4,noiseIntensity:j=.5,mixBlendMode:v="screen",pillarRotation:P=0,quality:b="high"})=>{const R=l.useRef(null),k=l.useRef(null),I=l.useRef(null),E=l.useRef(null),T=l.useRef(null),N=l.useRef(null),U=l.useRef(null),F=l.useRef(new Le(0,0)),o=l.useRef(0),[D,K]=l.useState(!0);return l.useEffect(()=>{const H=document.createElement("canvas");H.getContext("webgl")||H.getContext("experimental-webgl")||K(!1)},[]),l.useEffect(()=>{if(!R.current||!D)return;const H=R.current,A=H.clientWidth,V=H.clientHeight,M=new at;T.current=M;const q=new _t(-1,1,1,-1,0,1);N.current=q;const W=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),d=W||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<=4;let c=b;d&&b==="high"&&(c="medium"),W&&b!=="low"&&(c="low");const a={low:{iterations:24,waveIterations:1,pixelRatio:.5,precision:"mediump",stepMultiplier:1.5},medium:{iterations:40,waveIterations:2,pixelRatio:.65,precision:"mediump",stepMultiplier:1.2},high:{iterations:80,waveIterations:4,pixelRatio:Math.min(window.devicePixelRatio,2),precision:"highp",stepMultiplier:1}},p=a[c]||a.medium;let m;try{m=new lt({antialias:!1,alpha:!0,powerPreference:c==="high"?"high-performance":"low-power",precision:p.precision,stencil:!1,depth:!1})}catch{K(!1);return}m.setSize(A,V),m.setPixelRatio(p.pixelRatio),R.current.appendChild(m.domElement),I.current=m;const w=ue=>{const we=new Fe(ue);return new se(we.r,we.g,we.b)},B=`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = vec4(position, 1.0);
    ...
    `,re=P*Math.PI/180,$=Math.sin(.4),ie=Math.cos(.4),ne=new Ze({vertexShader:B,fragmentShader:Y,uniforms:{uTime:{value:0},uResolution:{value:new Le(A,V)},uMouse:{value:F.current},uTopColor:{value:w(n)},uBottomColor:{value:w(t)},uIntensity:{value:i},uInteractive:{value:u},uGlowAmount:{value:S},uPillarWidth:{value:C},uPillarHeight:{value:y},uNoiseIntensity:{value:j},uRotCos:{value:1},uRotSin:{value:0},uPillarRotCos:{value:Math.cos(re)},uPillarRotSin:{value:Math.sin(re)},uWaveSin:{value:$},uWaveCos:{value:ie}},transparent:!0,depthWrite:!1,depthTest:!1});E.current=ne;const O=new st(2,2);U.current=O;const ee=new et(O,ne);M.add(ee);let le=null;const z=ue=>{if(!u||le)return;le=window.setTimeout(()=>{le=null},16);const we=H.getBoundingClientRect(),L=(ue.clientX-we.left)/we.width*2-1,X=-((ue.clientY-we.top)/we.height)*2+1;F.current.set(L,X)};u&&window.addEventListener("pointermove",z,{passive:!0});let oe=performance.now();const ae=1e3/(c==="low"?30:60),xe=ue=>{if(!E.current||!I.current||!T.current||!N.current)return;const we=ue-oe;if(we>=ae){o.current+=.016*s;const L=o.current;E.current.uniforms.uTime.value=L,E.current.uniforms.uRotCos.value=Math.cos(L*.3),E.current.uniforms.uRotSin.value=Math.sin(L*.3),I.current.render(T.current,N.current),oe=ue-we%ae}k.current=requestAnimationFrame(xe)};k.current=requestAnimationFrame(xe);let ce=null;const pe=()=>{ce&&clearTimeout(ce),ce=window.setTimeout(()=>{if(!I.current||!E.current||!R.current)return;const ue=R.current.clientWidth,we=R.current.clientHeight;I.current.setSize(ue,we),E.current.uniforms.uResolution.value.set(ue,we)},150)};return window.addEventListener("resize",pe,{passive:!0}),()=>{window.removeEventListener("resize",pe),u&&window.removeEventListener("pointermove",z),k.current&&cancelAnimationFrame(k.current),I.current&&(I.current.dispose(),I.current.forceContextLoss(),H.contains(I.current.domElement)&&H.removeChild(I.current.domElement)),E.current&&E.current.dispose(),U.current&&U.current.dispose(),I.current=null,E.current=null,T.current=null,N.current=null,U.current=null,k.current=null}},[n,t,i,s,u,S,C,y,j,P,D,b]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
...
`;function js({color:n="#ffffff",flakeSize:t=.01,minFlakeSize:i=1.25,pixelResolution:s=200,speed:u=1.25,depthFade:h=8,farPlane:S=20,brightness:C=1,gamma:y=.4545,density:j=.3,variant:v="square",direction:P=125,rainbow:b=!1,storm:R=!1,className:k="",style:I={}}){const E=l.useRef(null),T=l.useRef(0),N=l.useRef(!0),U=l.useRef(null),F=l.useRef(null),o=l.useRef(null),D=l.useMemo(()=>v==="round"?1:v==="snowflake"?2:0,[v]),K=l.useMemo(()=>{const A=new Fe(n);return new se(A.r,A.g,A.b)},[n]),H=l.useCallback(()=>{o.current&&clearTimeout(o.current),o.current=window.setTimeout(()=>{const A=E.current,V=U.current,M=F.current;if(!A||!V||!M)return;const q=A.offsetWidth,W=A.offsetHeight;V.setSize(q,W),M.uniforms.uResolution.value.set(q,W)},100)},[]);return l.useEffect(()=>{const A=E.current;if(!A)return;const V=new IntersectionObserver(([M])=>{N.current=M.isIntersecting},{threshold:0});return V.observe(A),()=>V.disconnect()},[]),l.useEffect(()=>{const A=E.current;if(!A)return;const V=new at,M=new _t(-1,1,1,-1,0,1),q=new lt({antialias:!1,alpha:!0,premultipliedAlpha:!1,powerPreference:"high-performance",stencil:!1,depth:!1});q.setPixelRatio(Math.min(window.devicePixelRatio,2)),q.setSize(A.offsetWidth,A.offsetHeight),q.setClearColor(0,0),A.appendChild(q.domElement),U.current=q;const W=new Ze({vertexShader:Ss,fragmentShader:Cs,uniforms:{uTime:{value:0},uResolution:{value:new Le(A.offsetWidth,A.offsetHeight)},uFlakeSize:{value:t},uMinFlakeSize:{value:i},uPixelResolution:{value:s},uSpeed:{value:u},uDepthFade:{value:h},uFarPlane:{value:S},uColor:{value:K.clone()},uBrightness:{value:C},uGamma:{value:y},uDensity:{value:j},uVariant:{value:D},uDirection:{value:P*Math.PI/180},uRainbow:{value:b?1:0}},transparent:!0});F.current=W;const d=new st(2,2);V.add(new et(d,W)),window.addEventListener("resize",H);const c=performance.now(),a=()=>{T.current=requestAnimationFrame(a),N.current&&(W.uniforms.uTime.value=(performance.now()-c)*.001,q.render(V,M))};return a(),()=>{cancelAnimationFrame(T.current),window.removeEventListener("resize",H),o.current&&clearTimeout(o.current),A.contains(q.domElement)&&A.removeChild(q.domElement),q.dispose(),d.dispose(),W.dispose(),U.current=null,F.current=null}},[H]),l.useEffect(()=>{const A=F.current;A&&(A.uniforms.uFlakeSize.value=t,A.uniforms.uMinFlakeSize.value=i,A.uniforms.uPixelResolution.value=s,A.uniforms.uSpeed.value=R?u*4:u,A.uniforms.uDepthFade.value=h,A.uniforms.uFarPlane.value=S,A.uniforms.uBrightness.value=C,A.uniforms.uGamma.value=y,A.uniforms.uDensity.value=j,A.uniforms.uVariant.value=D,A.uniforms.uDirection.value=P*Math.PI/180,A.uniforms.uColor.value.copy(K),A.uniforms.uRainbow.value=b?1:0)},[t,i,s,u,h,S,C,y,j,D,P,K,b,R]),e.jsx("div",{ref:E,className:`pixel-snow-container ${k}`,style:{width:"100%",height:"100%",position:"relative",overflow:"hidden",contain:"layout style paint",...I}})}const Fi=[{name:"Neon",colors:["#f700ff","#bd71ff","#29b1ff"]},{name:"Fire",colors:["#ff0000","#ff7f00","#ffff00"]},{name:"Matrix",colors:["#00ff00","#003300","#ccffcc"]},{name:"Ice",colors:["#00ffff","#ffffff","#0088ff"]},{name:"CMY",colors:["#ff00ff","#ffff00","#00ffff"]}],ii={colors:Fi[0].colors,count:6,distance:5,bendRadius:5,bendStrength:-.5,enabledWaves:["top","middle","bottom"],interactive:!1,amplitude:1,rainbow:!1},Rs=[{label:"Baja",value:"low"},{label:"Media",value:"medium"},{label:"Alta",value:"high"}],ni={topColor:"#5227FF",bottomColor:"#FF9FFC",intensity:1,rotationSpeed:.3,pillarWidth:3,pillarHeight:.4,noiseIntensity:.5,pillarRotation:293,interactive:!1,glowAmount:.002,quality:"high"},oi={colors:["#f700ff","#bd71ff","#29b1ff"],count:60,gravity:.1,friction:.995,wallBounce:.9,followCursor:!1,enableExplosion:!1},si={color:"#9726fa",speed:4,scale:1,noiseIntensity:1.5,rotation:0},ri={density:1,glowIntensity:.5,saturation:1,hueShift:110,twinkleIntensity:.3,rotationSpeed:.1,starSpeed:.5,speed:.5,rainbow:!1,warp:!1},ai={color1:"#b117f8",color2:"#2c0b2e",speed:20},li={color:"#c9c9c9",flakeSize:.021,minFlakeSize:.6,pixelResolution:800,speed:.9,density:.6,direction:100,brightness:1.5,depthFade:3,farPlane:10,gamma:.4545,variant:"snowflake",rainbow:!1,storm:!1},He={cyberpunk:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:3,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.03,400*.2],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:1250072,brokenLines:1250072,leftCars:[14177983,6770850,12732332],rightCars:[242627,941733,3294549],sticks:242627}},akira:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"mountainDistortion",length:400,roadWidth:9,islandWidth:2,lanesPerRoad:3,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:50,lightPairsPerRoadWay:50,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.05,400*.15],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.2,.2],carFloorSeparation:[.05,1],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:1250072,brokenLines:1250072,leftCars:[16715818,15415358,16715818],rightCars:[14342906,12499683,9410532],sticks:14342906}},golden:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"deepDistortion",length:400,roadWidth:18,islandWidth:2,lanesPerRoad:3,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:50,lightPairsPerRoadWay:50,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.05,400*.15],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.2,.2],carFloorSeparation:[.05,1],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:1250072,brokenLines:1250072,leftCars:[16724527,10694672,11015432],rightCars:[16645616,15982240,14859144],sticks:16645616}},split:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"LongRaceDistortion",length:400,roadWidth:10,islandWidth:5,lanesPerRoad:2,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:50,lightPairsPerRoadWay:70,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.05,400*.15],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.2,.2],carFloorSeparation:[.05,1],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:1250072,brokenLines:1250072,leftCars:[16736115,15158624,16715818],rightCars:[10806246,8442324,5489350],sticks:10806246}},highway:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:9,islandWidth:2,lanesPerRoad:3,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:50,lightPairsPerRoadWay:50,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.05,400*.15],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.2,.2],carFloorSeparation:[.05,1],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:1250072,brokenLines:1250072,leftCars:[14441248,14459680,14426144],rightCars:[3361783,15066861,12568307],sticks:12970219}}},As=({onClose:n,floatingLinesConfig:t,setFloatingLinesConfig:i,lightPillarsConfig:s,setLightPillarsConfig:u,ballpitConfig:h,setBallpitConfig:S,silkConfig:C,setSilkConfig:y,galaxyConfig:j,setGalaxyConfig:v,gradientConfig:P,setGradientConfig:b,pixelSnowConfig:R,setPixelSnowConfig:k,hyperspeedConfig:I,setHyperspeedConfig:E})=>{const{activeBackground:T,floatingLinesConfig:N,setFloatingLinesConfig:U,lightPillarsConfig:F,setLightPillarsConfig:o,ballpitConfig:D,setBallpitConfig:K,silkConfig:H,setSilkConfig:A,galaxyConfig:V,setGalaxyConfig:M,gradientConfig:q,setGradientConfig:W,pixelSnowConfig:d,setPixelSnowConfig:c,hyperspeedConfig:a,setHyperspeedConfig:p}=Ue(),m=t||N,w=i||U,B=s||F,Y=u||o,re=h||D,$=S||K,ie=C||H,ne=y||A,O=j||V,ee=v||M,le=P||q,z=b||W,oe=R||d,ve=k||c,ae=I||a,xe=E||p,ce=m||ii,pe=(f,ge)=>{w&&w({...ce,[f]:ge})},ue=f=>{const ge=ce.enabledWaves,Me=ge.includes(f)?ge.filter(jt=>jt!==f):[...ge,f];pe("enabledWaves",Me)},we=(f,ge)=>{const Me=[...ce.colors];Me[f]=ge,pe("colors",Me)},L=B||ni,X=(f,ge)=>{Y?Y({...L,[f]:ge}):console.warn("setLightPillarsConfig no está definido en el store. Asegúrate de agregarlo.")},J=re||oi,Z=(f,ge)=>{$&&$({...J,[f]:ge})},Se=(f,ge)=>{const Me=[...J.colors];Me[f]=ge,Z("colors",Me)},he=ie||si,ye=(f,ge)=>{ne&&ne({...he,[f]:ge})},de=O||ri,Ce=(f,ge)=>{ee&&ee({...de,[f]:ge})},De=le||ai,qe=(f,ge)=>{z&&z({...De,[f]:ge})},be=oe||li,je=(f,ge)=>{ve&&ve({...be,[f]:ge})},ke=ae||He.cyberpunk,St=f=>{xe&&He[f]&&xe(He[f])},$e=(f,ge)=>{xe&&xe({...ke,[f]:ge})},Ct=()=>{T==="floatinglines"&&w?w(ii):T==="lightpillars"&&Y?Y(ni):T==="ballpit"&&$?$(oi):T==="silk"&&ne?ne(si):T==="galaxy"&&ee?ee(ri):T==="gradient"&&z?z(ai):T==="pixelsnow"&&ve?ve(li):T==="hyperspeed"&&xe&&xe(He.cyberpunk)};return e.jsxs("div",{className:"bg-customizer-panel",style:{pointerEvents:"auto"},children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"bg-customizer-header",children:[e.jsx("h3",{children:"Personalizar Fondo"}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx("button",{onClick:Ct,className:"reset-btn",title:"Restaurar valores por defecto",children:e.jsx(wn,{})}),e.jsx("button",{onClick:n,className:"close-btn",children:e.jsx(xt,{})})]})]}),e.jsxs("div",{className:"bg-customizer-content",children:[T==="floatinglines"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Presets de Color"}),e.jsx("div",{className:"presets-grid",children:Fi.map(f=>e.jsx("button",{className:"preset-btn",onClick:()=>pe("colors",f.colors),style:{background:`linear-gradient(to right, ${f.colors[0]}, ${f.colors[1]}, ${f.colors[2]})`},title:f.name,children:JSON.stringify(ce.colors)===JSON.stringify(f.colors)&&e.jsx(vi,{})},f.name))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Colores Personalizados"}),e.jsx("div",{className:"color-pickers",children:ce.colors.map((f,ge)=>e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("input",{type:"color",value:f,onChange:Me=>we(ge,Me.target.value)}),e.jsx("span",{className:"hex-code",children:f})]},ge))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Cantidad de Líneas ",e.jsx("span",{children:ce.count})]}),e.jsx("input",{type:"range",min:"1",max:"20",value:ce.count,onChange:f=>pe("count",parseInt(f.target.value))}),e.jsxs("label",{children:["Distancia entre Líneas ",e.jsx("span",{children:ce.distance})]}),e.jsx("input",{type:"range",min:"1",max:"20",value:ce.distance,onChange:f=>pe("distance",parseInt(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Amplitud de Onda ",e.jsx("span",{children:ce.amplitude})]}),e.jsx("input",{type:"range",min:"0.1",max:"3",step:"0.1",value:ce.amplitude||1,onChange:f=>pe("amplitude",parseFloat(f.target.value))}),e.jsxs("label",{children:["Radio de Curvatura ",e.jsx("span",{children:ce.bendRadius})]}),e.jsx("input",{type:"range",min:"5",max:"10",step:"0.1",value:ce.bendRadius,onChange:f=>pe("bendRadius",parseFloat(f.target.value))}),e.jsxs("label",{children:["Fuerza de Curvatura ",e.jsx("span",{children:ce.bendStrength})]}),e.jsx("input",{type:"range",min:"-7",max:"7",step:"0.1",value:ce.bendStrength,onChange:f=>pe("bendStrength",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Capas Activas"}),e.jsx("div",{className:"toggles-row",children:["top","middle","bottom"].map(f=>e.jsx("button",{className:`toggle-btn ${ce.enabledWaves.includes(f)?"active":""}`,onClick:()=>ue(f),children:f.charAt(0).toUpperCase()+f.slice(1)},f))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Interacción"}),e.jsx("button",{className:`toggle-btn ${ce.interactive!==!1?"active":""}`,onClick:()=>pe("interactive",ce.interactive===!1),style:{width:"100%",textAlign:"center"},children:ce.interactive!==!1?"Activada (Ratón)":"Desactivada"})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Efectos"}),e.jsx("button",{className:`toggle-btn ${ce.rainbow?"active":""}`,onClick:()=>pe("rainbow",!ce.rainbow),style:{width:"100%",textAlign:"center"},children:"🌈 Modo Arcoíris"})]})]}),T==="lightpillars"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Colores"}),e.jsxs("div",{className:"color-pickers",children:[e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("label",{style:{fontSize:"0.8rem",marginBottom:5},children:"Superior"}),e.jsx("input",{type:"color",value:L.topColor,onChange:f=>X("topColor",f.target.value)})]}),e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("label",{style:{fontSize:"0.8rem",marginBottom:5},children:"Inferior"}),e.jsx("input",{type:"color",value:L.bottomColor,onChange:f=>X("bottomColor",f.target.value)})]})]})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Intensidad ",e.jsx("span",{children:L.intensity})]}),e.jsx("input",{type:"range",min:"0.1",max:"3",step:"0.1",value:L.intensity,onChange:f=>X("intensity",parseFloat(f.target.value))}),e.jsxs("label",{children:["Velocidad ",e.jsx("span",{children:L.rotationSpeed})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:L.rotationSpeed,onChange:f=>X("rotationSpeed",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Ancho del Pilar ",e.jsx("span",{children:L.pillarWidth})]}),e.jsx("input",{type:"range",min:"0.5",max:"10",step:"0.5",value:L.pillarWidth,onChange:f=>X("pillarWidth",parseFloat(f.target.value))}),e.jsxs("label",{children:["Rotación ",e.jsxs("span",{children:[L.pillarRotation,"°"]})]}),e.jsx("input",{type:"range",min:"0",max:"360",step:"5",value:L.pillarRotation,onChange:f=>X("pillarRotation",parseInt(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Altura del Pilar ",e.jsx("span",{children:L.pillarHeight})]}),e.jsx("input",{type:"range",min:"0.1",max:"2",step:"0.1",value:L.pillarHeight,onChange:f=>X("pillarHeight",parseFloat(f.target.value))}),e.jsxs("label",{children:["Intensidad Ruido ",e.jsx("span",{children:L.noiseIntensity})]}),e.jsx("input",{type:"range",min:"0",max:"1",step:"0.05",value:L.noiseIntensity,onChange:f=>X("noiseIntensity",parseFloat(f.target.value))}),e.jsxs("label",{children:["Resplandor ",e.jsx("span",{children:L.glowAmount})]}),e.jsx("input",{type:"range",min:"0.0001",max:"0.02",step:"0.0001",value:L.glowAmount,onChange:f=>X("glowAmount",parseFloat(f.target.value))})]}),e.jsx("div",{className:"section",children:e.jsx("div",{className:"toggles-row",children:Rs.map(f=>e.jsx("button",{className:`toggle-btn ${L.quality===f.value?"active":""}`,onClick:()=>X("quality",f.value),children:f.label},f.value))})}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Interacción"}),e.jsx("button",{className:`toggle-btn ${L.interactive!==!1?"active":""}`,onClick:()=>X("interactive",L.interactive===!1),style:{width:"100%",textAlign:"center"},children:L.interactive!==!1?"Activada (Ratón)":"Desactivada"})]})]}),T==="ballpit"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Colores"}),e.jsx("div",{className:"color-pickers",children:J.colors.map((f,ge)=>e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("input",{type:"color",value:f,onChange:Me=>Se(ge,Me.target.value)}),e.jsx("span",{className:"hex-code",children:f})]},ge))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Cantidad ",e.jsx("span",{children:J.count})]}),e.jsx("input",{type:"range",min:"10",max:"200",step:"10",value:J.count,onChange:f=>Z("count",parseInt(f.target.value))}),e.jsxs("label",{children:["Gravedad ",e.jsx("span",{children:J.gravity})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:J.gravity,onChange:f=>Z("gravity",parseFloat(f.target.value))}),e.jsxs("label",{children:["Fricción ",e.jsx("span",{children:J.friction})]}),e.jsx("input",{type:"range",min:"0.8",max:"1",step:"0.001",value:J.friction,onChange:f=>Z("friction",parseFloat(f.target.value))}),e.jsxs("label",{children:["Rebote Pared ",e.jsx("span",{children:J.wallBounce})]}),e.jsx("input",{type:"range",min:"0",max:"1.5",step:"0.05",value:J.wallBounce,onChange:f=>Z("wallBounce",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Interacción"}),e.jsx("button",{className:`toggle-btn ${J.followCursor?"active":""}`,onClick:()=>Z("followCursor",!J.followCursor),style:{width:"100%",textAlign:"center"},children:J.followCursor?"Seguir Cursor":"Cursor Libre"})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Eventos Divertidos"}),e.jsxs("div",{className:"toggles-row",children:[e.jsx("button",{className:`toggle-btn ${J.enableExplosion?"active":""}`,onClick:()=>Z("enableExplosion",!J.enableExplosion),title:"Haz clic para explotar las bolas",children:"💥 Explosión al Clic"}),e.jsx("button",{className:`toggle-btn ${J.rainbow?"active":""}`,onClick:()=>Z("rainbow",!J.rainbow),title:"Ciclo de colores automático",children:"🌈 Modo Arcoíris"})]})]})]}),T==="silk"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Color"}),e.jsx("div",{className:"color-pickers",children:e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("input",{type:"color",value:he.color,onChange:f=>ye("color",f.target.value)}),e.jsx("span",{className:"hex-code",children:he.color})]})})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Velocidad ",e.jsx("span",{children:he.speed})]}),e.jsx("input",{type:"range",min:"0.1",max:"10",step:"0.1",value:he.speed,onChange:f=>ye("speed",parseFloat(f.target.value))}),e.jsxs("label",{children:["Escala ",e.jsx("span",{children:he.scale})]}),e.jsx("input",{type:"range",min:"0.5",max:"3",step:"0.1",value:he.scale,onChange:f=>ye("scale",parseFloat(f.target.value))}),e.jsxs("label",{children:["Ruido ",e.jsx("span",{children:he.noiseIntensity})]}),e.jsx("input",{type:"range",min:"0",max:"5",step:"0.1",value:he.noiseIntensity,onChange:f=>ye("noiseIntensity",parseFloat(f.target.value))}),e.jsxs("label",{children:["Rotación ",e.jsxs("span",{children:[he.rotation,"°"]})]}),e.jsx("input",{type:"range",min:"0",max:"360",step:"15",value:he.rotation,onChange:f=>ye("rotation",parseInt(f.target.value))})]})]}),T==="galaxy"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Densidad ",e.jsx("span",{children:de.density})]}),e.jsx("input",{type:"range",min:"0.1",max:"2",step:"0.1",value:de.density,onChange:f=>Ce("density",parseFloat(f.target.value))}),e.jsxs("label",{children:["Intensidad Brillo ",e.jsx("span",{children:de.glowIntensity})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:de.glowIntensity,onChange:f=>Ce("glowIntensity",parseFloat(f.target.value))}),e.jsxs("label",{children:["Saturación ",e.jsx("span",{children:de.saturation})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:de.saturation,onChange:f=>Ce("saturation",parseFloat(f.target.value))}),e.jsxs("label",{children:["Cambio de Tono (Hue) ",e.jsx("span",{children:de.hueShift})]}),e.jsx("input",{type:"range",min:"0",max:"360",step:"5",value:de.hueShift,onChange:f=>Ce("hueShift",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Velocidad Rotación ",e.jsx("span",{children:de.rotationSpeed})]}),e.jsx("input",{type:"range",min:"-0.5",max:"0.5",step:"0.01",value:de.rotationSpeed,onChange:f=>Ce("rotationSpeed",parseFloat(f.target.value))}),e.jsxs("label",{children:["Velocidad Estrellas ",e.jsx("span",{children:de.starSpeed})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:de.starSpeed,onChange:f=>Ce("starSpeed",parseFloat(f.target.value))}),e.jsxs("label",{children:["Velocidad Animación ",e.jsx("span",{children:de.speed})]}),e.jsx("input",{type:"range",min:"0",max:"2",step:"0.1",value:de.speed,onChange:f=>Ce("speed",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Efectos"}),e.jsx("button",{className:`toggle-btn ${de.rainbow?"active":""}`,onClick:()=>Ce("rainbow",!de.rainbow),style:{width:"100%",textAlign:"center"},children:"🌈 Modo Arcoíris"}),e.jsx("button",{className:`toggle-btn ${de.warp?"active":""}`,onClick:()=>Ce("warp",!de.warp),style:{width:"100%",textAlign:"center",marginTop:"10px"},children:"🚀 Velocidad Warp"})]})]}),T==="gradient"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Colores"}),e.jsxs("div",{className:"color-pickers",children:[e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("label",{style:{fontSize:"0.8rem",marginBottom:5},children:"Superior"}),e.jsx("input",{type:"color",value:De.color1,onChange:f=>qe("color1",f.target.value)})]}),e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("label",{style:{fontSize:"0.8rem",marginBottom:5},children:"Inferior"}),e.jsx("input",{type:"color",value:De.color2,onChange:f=>qe("color2",f.target.value)})]})]})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Velocidad (segundos) ",e.jsxs("span",{children:[De.speed,"s"]})]}),e.jsx("input",{type:"range",min:"1",max:"60",step:"1",value:De.speed,onChange:f=>qe("speed",parseInt(f.target.value))})]})]}),T==="pixelsnow"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Color"}),e.jsx("div",{className:"color-pickers",children:e.jsxs("div",{className:"color-input-wrapper",children:[e.jsx("input",{type:"color",value:be.color,onChange:f=>je("color",f.target.value)}),e.jsx("span",{className:"hex-code",children:be.color})]})})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Variante"}),e.jsx("div",{className:"toggles-row",children:["snowflake","square","round"].map(f=>e.jsx("button",{className:`toggle-btn ${be.variant===f?"active":""}`,onClick:()=>je("variant",f),children:f.charAt(0).toUpperCase()+f.slice(1)},f))})]}),e.jsxs("div",{className:"section",children:[e.jsxs("label",{children:["Velocidad ",e.jsx("span",{children:be.speed})]}),e.jsx("input",{type:"range",min:"0",max:"5",step:"0.1",value:be.speed,onChange:f=>je("speed",parseFloat(f.target.value))}),e.jsxs("label",{children:["Densidad ",e.jsx("span",{children:be.density})]}),e.jsx("input",{type:"range",min:"0",max:"1",step:"0.05",value:be.density,onChange:f=>je("density",parseFloat(f.target.value))}),e.jsxs("label",{children:["Dirección ",e.jsxs("span",{children:[be.direction,"°"]})]}),e.jsx("input",{type:"range",min:"0",max:"360",step:"5",value:be.direction,onChange:f=>je("direction",parseInt(f.target.value))}),e.jsxs("label",{children:["Tamaño Copo ",e.jsx("span",{children:be.flakeSize})]}),e.jsx("input",{type:"range",min:"0.005",max:"0.05",step:"0.001",value:be.flakeSize,onChange:f=>je("flakeSize",parseFloat(f.target.value))}),e.jsxs("label",{children:["Brillo ",e.jsx("span",{children:be.brightness})]}),e.jsx("input",{type:"range",min:"0.5",max:"3",step:"0.1",value:be.brightness,onChange:f=>je("brightness",parseFloat(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Efectos"}),e.jsx("button",{className:`toggle-btn ${be.rainbow?"active":""}`,onClick:()=>je("rainbow",!be.rainbow),style:{width:"100%",textAlign:"center"},children:"🌈 Modo Arcoíris"}),e.jsx("button",{className:`toggle-btn ${be.storm?"active":""}`,onClick:()=>je("storm",!be.storm),style:{width:"100%",textAlign:"center",marginTop:"10px"},children:"🌪️ Modo Tormenta"})]})]}),T==="hyperspeed"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Estilo Visual"}),e.jsx("div",{className:"toggles-row",style:{flexWrap:"wrap"},children:Object.keys(He).map(f=>e.jsx("button",{className:`toggle-btn ${JSON.stringify(ke.colors)===JSON.stringify(He[f].colors)?"active":""}`,onClick:()=>St(f),children:f.charAt(0).toUpperCase()+f.slice(1)},f))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Geometría"}),e.jsxs("label",{children:["Ancho Carretera ",e.jsx("span",{children:ke.roadWidth})]}),e.jsx("input",{type:"range",min:"5",max:"30",step:"1",value:ke.roadWidth,onChange:f=>$e("roadWidth",parseFloat(f.target.value))}),e.jsxs("label",{children:["Ancho Isla ",e.jsx("span",{children:ke.islandWidth})]}),e.jsx("input",{type:"range",min:"1",max:"10",step:"0.5",value:ke.islandWidth,onChange:f=>$e("islandWidth",parseFloat(f.target.value))}),e.jsxs("label",{children:["Carriles ",e.jsx("span",{children:ke.lanesPerRoad})]}),e.jsx("input",{type:"range",min:"1",max:"5",step:"1",value:ke.lanesPerRoad,onChange:f=>$e("lanesPerRoad",parseInt(f.target.value))})]}),e.jsxs("div",{className:"section",children:[e.jsx("label",{children:"Distorsión"}),e.jsxs("select",{value:ke.distortion,onChange:f=>$e("distortion",f.target.value),style:{width:"100%",padding:"8px",borderRadius:"8px",background:"rgba(255, 255, 255, 0.1)",color:"white",border:"1px solid rgba(255, 255, 255, 0.2)",marginTop:"5px",cursor:"pointer"},children:[e.jsx("option",{style:{color:"black"},value:"turbulentDistortion",children:"Turbulent"}),e.jsx("option",{style:{color:"black"},value:"deepDistortion",children:"Deep"}),e.jsx("option",{style:{color:"black"},value:"mountainDistortion",children:"Mountain"}),e.jsx("option",{style:{color:"black"},value:"xyDistortion",children:"XY"}),e.jsx("option",{style:{color:"black"},value:"LongRaceDistortion",children:"Long Race"})]})]})]})]})]})},Ls=({effectOptions:n=He.cyberpunk})=>{const t=l.useRef(null),i=l.useRef(null);return l.useEffect(()=>{if(i.current){i.current.dispose();const d=document.getElementById("lights");if(d)for(;d.firstChild;)d.removeChild(d.firstChild)}const s={uFreq:{value:new se(3,6,10)},uAmp:{value:new se(30,30,20)}},u={uFreq:{value:new Le(5,2)},uAmp:{value:new Le(25,15)}},h={uFreq:{value:new Le(2,3)},uAmp:{value:new Le(35,10)}},S={uFreq:{value:new Gt(4,8,8,1)},uAmp:{value:new Gt(25,5,10,10)}},C={uFreq:{value:new Le(4,8)},uAmp:{value:new Le(10,20)},uPowY:{value:new Le(20,2)}};let y=d=>Math.sin(d)*.5+.5;const j={mountainDistortion:{uniforms:s,getDistortion:`
        ...
        `,getJS:(d,c)=>{const a=S.uFreq.value,p=S.uAmp.value,m=$=>Math.cos(Math.PI*$*a.x+c)*p.x+Math.pow(Math.cos(Math.PI*$*a.y+c*(a.y/a.x)),2)*p.y,w=$=>-y(Math.PI*$*a.z+c)*p.z-Math.pow(y(Math.PI*$*a.w+c/(a.z/a.w)),5)*p.w;let B=new se(m(d)-m(d+.007),w(d)-w(d+.007),0),Y=new se(-2,-5,0),re=new se(0,0,-10);return B.multiply(Y).add(re)}},turbulentDistortionStill:{uniforms:S,getDistortion:`
          uniform vec4 uFreq;
          uniform vec4 uAmp;
          float nsin(float val){
            return sin(val) * 0.5 + 0.5;
    ...
    `,R=d=>Array.isArray(d)?Math.random()*(d[1]-d[0])+d[0]:Math.random()*d,k=d=>Array.isArray(d)?d[Math.floor(Math.random()*d.length)]:d;function I(d,c,a=.1,p=.001){let m=(c-d)*a;return Math.abs(m)<p&&(m=c-d),m}class E{constructor(c,a,p,m,w){this.webgl=c,this.options=a,this.colors=p,this.speed=m,this.fade=w}init(){const c=this.options;let a=new Pn(new se(0,0,0),new se(0,0,-1)),p=new En(a,40,1,8,!1),m=new Yt().copy(p);m.instanceCount=c.lightPairsPerRoadWay*2;let w=c.roadWidth/c.lanesPerRoad,B=[],Y=[],re=[],$=this.colors;Array.isArray($)?$=$.map(O=>new Fe(O)):$=new Fe($);for(let O=0;O<c.lightPairsPerRoadWay;O++){let ee=R(c.carLightsRadius),le=R(c.carLightsLength),z=R(this.speed),ve=O%c.lanesPerRoad*w-c.roadWidth/2+w/2,ae=R(c.carWidthPercentage)*w,xe=R(c.carShiftX)*w;ve+=xe;let ce=R(c.carFloorSeparation)+ee*1.3,pe=-R(c.length);B.push(ve-ae/2),B.push(ce),B.push(pe),B.push(ve+ae/2),B.push(ce),B.push(pe),Y.push(ee),Y.push(le),Y.push(z),Y.push(ee),Y.push(le),Y.push(z);let ue=k($);re.push(ue.r),re.push(ue.g),re.push(ue.b),re.push(ue.r),re.push(ue.g),re.push(ue.b)}m.setAttribute("aOffset",new Je(new Float32Array(B),3,!1)),m.setAttribute("aMetrics",new Je(new Float32Array(Y),3,!1)),m.setAttribute("aColor",new Je(new Float32Array(re),3,!1));let ie=new Ze({fragmentShader:T,vertexShader:N,transparent:!0,uniforms:Object.assign({uTime:{value:0},uTravelLength:{value:c.length},uFade:{value:this.fade}},this.webgl.fogUniforms,c.distortion.uniforms)});ie.onBeforeCompile=O=>{O.vertexShader=O.vertexShader.replace("#include <getDistortion_vertex>",c.distortion.getDistortion)};let ne=new et(m,ie);ne.frustumCulled=!1,this.webgl.scene.add(ne),this.mesh=ne}update(c){this.mesh.material.uniforms.uTime.value=c}}const T=`
      #define USE_FOG;
    ...
    `;class U{constructor(c,a){this.webgl=c,this.options=a}init(){const c=this.options,a=new st(1,1);let p=new Yt().copy(a),m=c.totalSideLightSticks;p.instanceCount=m;let w=c.length/(m-1);const B=[],Y=[],re=[];let $=c.colors.sticks;Array.isArray($)?$=$.map(O=>new Fe(O)):$=new Fe($);for(let O=0;O<m;O++){let ee=R(c.lightStickWidth),le=R(c.lightStickHeight);B.push((O-1)*w*2+w*Math.random());let z=k($);Y.push(z.r),Y.push(z.g),Y.push(z.b),re.push(ee),re.push(le)}p.setAttribute("aOffset",new Je(new Float32Array(B),1,!1)),p.setAttribute("aColor",new Je(new Float32Array(Y),3,!1)),p.setAttribute("aMetrics",new Je(new Float32Array(re),2,!1));const ie=new Ze({fragmentShader:o,vertexShader:F,side:Wt,uniforms:Object.assign({uTravelLength:{value:c.length},uTime:{value:0}},this.webgl.fogUniforms,c.distortion.uniforms)});ie.onBeforeCompile=O=>{O.vertexShader=O.vertexShader.replace("#include <getDistortion_vertex>",c.distortion.getDistortion)};const ne=new et(p,ie);ne.frustumCulled=!1,this.webgl.scene.add(ne),this.mesh=ne}update(c){this.mesh.material.uniforms.uTime.value=c}}const F=`
      #define USE_FOG;
      ${Ie.fog_pars_vertex}
    ...
    `,H=K.replace("#include <roadMarkings_fragment>","").replace("#include <roadMarkings_vars>",""),M=K.replace("#include <roadMarkings_fragment>",`
    ...
    `;function W(d,c){const a=d.domElement,p=a.clientWidth,m=a.clientHeight,w=a.width!==p||a.height!==m;return w&&c(p,m,!1),w}return(function(){const d=document.getElementById("lights"),c={...n};c.distortion=j[c.distortion];const a=new v(d,c);i.current=a,a.loadAssets().then(a.init)})(),()=>{i.current&&i.current.dispose()}},[n]),e.jsx("div",{id:"lights",ref:t})},Ps=({floatingLinesConfig:n,lightPillarsConfig:t,ballpitConfig:i,silkConfig:s,galaxyConfig:u,gradientConfig:h,pixelSnowConfig:S,hyperspeedConfig:C})=>{const{activeBackground:y,floatingLinesConfig:j,lightPillarsConfig:v,ballpitConfig:P,silkConfig:b,galaxyConfig:R,gradientConfig:k,pixelSnowConfig:I,hyperspeedConfig:E}=Ue(),T=n||j,N=t||v,U=i||P,F=s||b,o=u||R,D=h||k,K=S||I,H=C||E,A=T||{colors:["#f700ff","#bd71ff","#29b1ff"],count:6,distance:5,bendRadius:5,bendStrength:-.5,enabledWaves:["top","middle","bottom"],interactive:!1,amplitude:1,rainbow:!1},V=N||{topColor:"#5227FF",bottomColor:"#FF9FFC",intensity:1,rotationSpeed:.3,pillarWidth:3,pillarHeight:.4,noiseIntensity:.5,pillarRotation:293,interactive:!1,glowAmount:.002,quality:"high"},M=U||{colors:["#f700ff","#bd71ff","#29b1ff"],count:60,gravity:.1,friction:.995,wallBounce:.9,followCursor:!1,enableExplosion:!1,rainbow:!1},q=F||{color:"#9726fa",speed:4,scale:1,noiseIntensity:1.5,rotation:0},W=o||{density:1,glowIntensity:.5,saturation:1,hueShift:110,twinkleIntensity:.3,rotationSpeed:.1,starSpeed:.5,speed:.5,rainbow:!1,warp:!1},d=D||{color1:"#b117f8",color2:"#2c0b2e",speed:20},c=K||{color:"#c9c9c9",flakeSize:.021,minFlakeSize:.6,pixelResolution:800,speed:.9,density:.6,direction:100,brightness:1.5,variant:"snowflake",rainbow:!1,storm:!1};return e.jsx("div",{style:{position:"absolute",inset:0,zIndex:0},children:e.jsxs(Te,{mode:"wait",children:[y==="gradient"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0},children:e.jsx(is,{color1:d.color1,color2:d.color2,speed:d.speed})},"gradient"),y==="galaxy"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1.5},style:{position:"absolute",inset:0,background:"#050010"},children:e.jsx(rs,{density:W.density,glowIntensity:W.glowIntensity,saturation:W.saturation,hueShift:W.hueShift,twinkleIntensity:W.twinkleIntensity,rotationSpeed:W.rotationSpeed,starSpeed:W.starSpeed,speed:W.speed,rainbow:W.rainbow,warp:W.warp})},"galaxy"),y==="silk"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0},children:e.jsx(Si,{speed:q.speed,scale:q.scale,color:q.color,noiseIntensity:q.noiseIntensity,rotation:q.rotation})},"silk"),y==="ballpit"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0,background:"#111111"},children:e.jsx(vs,{count:M.count,gravity:M.gravity,friction:M.friction,wallBounce:M.wallBounce,followCursor:M.followCursor,colors:M.colors,enableExplosion:M.enableExplosion,rainbow:M.rainbow})},"ballpit"),y==="floatinglines"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0,background:"#000"},children:e.jsx(bs,{linesGradient:A.colors,lineCount:A.count,lineDistance:A.distance,animationSpeed:.5,bendRadius:A.bendRadius,bendStrength:A.bendStrength,enabledWaves:A.enabledWaves,interactive:A.interactive??!1,parallax:A.parallax??!1,amplitude:A.amplitude??1,rainbow:A.rainbow})},"floatinglines"),y==="lightpillars"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0,background:"#000"},children:e.jsx(ws,{topColor:V.topColor,bottomColor:V.bottomColor,intensity:V.intensity,rotationSpeed:V.rotationSpeed,glowAmount:V.glowAmount??.002,pillarWidth:V.pillarWidth,pillarHeight:V.pillarHeight,noiseIntensity:V.noiseIntensity,pillarRotation:V.pillarRotation,interactive:V.interactive??!0,quality:V.quality??"high"})},"lightpillars"),y==="pixelsnow"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0,background:"#000"},children:e.jsx(js,{color:c.color,flakeSize:c.flakeSize,minFlakeSize:c.minFlakeSize,pixelResolution:c.pixelResolution,speed:c.speed,density:c.density,direction:c.direction,brightness:c.brightness,variant:c.variant,rainbow:c.rainbow,storm:c.storm})},"pixelsnow"),y==="hyperspeed"&&e.jsx(te.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1},style:{position:"absolute",inset:0,background:"#000"},children:e.jsx(Ls,{effectOptions:H})},"hyperspeed")]})})},Es=({onItemClick:n,isOpen:t,onToggle:i,position:s="left",colors:u=["#B19EEF","#5227FF"],items:h=[],socialItems:S=[],displaySocials:C=!0,displayItemNumbering:y=!0,className:j,logoUrl:v=null,menuButtonColor:P="#fff",openMenuButtonColor:b="#000",accentColor:R="#5227FF",changeMenuColorOnOpen:k=!0,isFixed:I=!1,closeOnClickAway:E=!0,onMenuOpen:T,onMenuClose:N})=>{const[U,F]=l.useState(!1),o=typeof t=="boolean",D=o?t:U,K=l.useRef(!1),H=l.useRef(null),A=l.useRef(null),V=l.useRef([]),M=l.useRef(null),q=l.useRef(null),W=l.useRef(null),d=l.useRef(null),c=l.useRef(null),[a,p]=l.useState(["Menu","Close"]),m=l.useRef(null),w=l.useRef(null),B=l.useRef(null),Y=l.useRef(null),re=l.useRef(null),$=l.useRef(null),ie=l.useRef(!1),ne=l.useRef(null),O=l.useRef(null),ee=l.useRef(null);l.useLayoutEffect(()=>{const L=G.context(()=>{const X=H.current,J=A.current,Z=M.current,Se=q.current,he=W.current,ye=d.current;if(!X||!Z||!Se||!he||!ye)return;let de=[];J&&(de=Array.from(J.querySelectorAll(".sm-prelayer"))),V.current=de;const Ce=s==="left"?-100:100;G.set([X,...de],{xPercent:Ce}),G.set(Z,{transformOrigin:"50% 50%",rotate:0}),G.set(Se,{transformOrigin:"50% 50%",rotate:90}),G.set(he,{rotate:0,transformOrigin:"50% 50%"}),G.set(ye,{yPercent:0}),$.current&&G.set($.current,{color:P})});return()=>L.revert()},[P,s]);const le=l.useCallback(()=>{const L=H.current,X=V.current;if(!L)return null;m.current?.kill(),w.current&&(w.current.kill(),w.current=null),ne.current?.kill();const J=Array.from(L.querySelectorAll(".sm-panel-itemLabel")),Z=Array.from(L.querySelectorAll(".sm-panel-list[data-numbering] .sm-panel-item")),Se=L.querySelector(".sm-socials-title"),he=Array.from(L.querySelectorAll(".sm-socials-link")),ye=X.map(je=>({el:je,start:Number(G.getProperty(je,"xPercent"))})),de=Number(G.getProperty(L,"xPercent"));J.length&&G.set(J,{yPercent:140,rotate:10}),Z.length&&G.set(Z,{"--sm-num-opacity":0}),Se&&G.set(Se,{opacity:0}),he.length&&G.set(he,{y:25,opacity:0});const Ce=G.timeline({paused:!0});ye.forEach((je,ke)=>{Ce.fromTo(je.el,{xPercent:je.start},{xPercent:0,duration:.8,ease:"power4.out"},ke*.07)});const qe=(ye.length?(ye.length-1)*.07:0)+(ye.length?.08:0),be=1;if(Ce.fromTo(L,{xPercent:de},{xPercent:0,duration:be,ease:"power4.out"},qe),J.length){const ke=qe+be*.15;Ce.to(J,{yPercent:0,rotate:0,duration:1,ease:"power4.out",stagger:{each:.1,from:"start"}},ke),Z.length&&Ce.to(Z,{duration:.6,ease:"power2.out","--sm-num-opacity":1,stagger:{each:.08,from:"start"}},ke+.1)}if(Se||he.length){const je=qe+be*.4;Se&&Ce.to(Se,{opacity:1,duration:.5,ease:"power2.out"},je),he.length&&Ce.to(he,{y:0,opacity:1,duration:.55,ease:"power3.out",stagger:{each:.08,from:"start"},onComplete:()=>{G.set(he,{clearProps:"opacity"})}},je+.04)}return m.current=Ce,Ce},[]),z=l.useCallback(()=>{if(ie.current)return;ie.current=!0;const L=le();L?(L.eventCallback("onComplete",()=>{ie.current=!1}),L.play(0)):ie.current=!1},[le]),oe=l.useCallback(()=>{m.current?.kill(),m.current=null,ne.current?.kill();const L=H.current,X=V.current;if(!L)return;const J=[...X,L];w.current?.kill();const Z=s==="left"?-100:100;w.current=G.to(J,{xPercent:Z,duration:.32,ease:"power3.in",overwrite:"auto",onComplete:()=>{const Se=Array.from(L.querySelectorAll(".sm-panel-itemLabel"));Se.length&&G.set(Se,{yPercent:140,rotate:10});const he=Array.from(L.querySelectorAll(".sm-panel-list[data-numbering] .sm-panel-item"));he.length&&G.set(he,{"--sm-num-opacity":0});const ye=L.querySelector(".sm-socials-title"),de=Array.from(L.querySelectorAll(".sm-socials-link"));ye&&G.set(ye,{opacity:0}),de.length&&G.set(de,{y:25,opacity:0}),ie.current=!1}})},[s]),ve=l.useCallback(L=>{const X=W.current;X&&(B.current?.kill(),L?B.current=G.to(X,{rotate:225,duration:.8,ease:"power4.out",overwrite:"auto"}):B.current=G.to(X,{rotate:0,duration:.35,ease:"power3.inOut",overwrite:"auto"}))},[]),ae=l.useCallback(L=>{const X=$.current;if(X)if(re.current?.kill(),k){const J=L?b:P;re.current=G.to(X,{color:J,delay:.18,duration:.3,ease:"power2.out"})}else G.set(X,{color:P})},[b,P,k]);gt.useEffect(()=>{if($.current)if(k){const L=K.current?b:P;G.set($.current,{color:L})}else G.set($.current,{color:P})},[k,P,b]);const xe=l.useCallback(L=>{const X=d.current;if(!X)return;Y.current?.kill();const J=L?"Menu":"Close",Z=L?"Close":"Menu",Se=3,he=[J];let ye=J;for(let De=0;De<Se;De++)ye=ye==="Menu"?"Close":"Menu",he.push(ye);ye!==Z&&he.push(Z),he.push(Z),p(he),G.set(X,{yPercent:0});const de=he.length,Ce=(de-1)/de*100;Y.current=G.to(X,{yPercent:-Ce,duration:.5+de*.07,ease:"power4.out"})},[]),ce=l.useCallback(()=>{if(o)i&&i(!D);else{const L=!K.current;K.current=L,F(L),L?(T?.(),z()):(N?.(),oe()),ve(L),ae(L),xe(L)}},[o,t,i,D,z,oe,ve,ae,xe,T,N]);gt.useEffect(()=>{o&&(K.current=t,t?(T?.(),z()):(N?.(),oe()),ve(t),ae(t),xe(t))},[t,o,z,oe,ve,ae,xe,T,N]);const pe=l.useCallback(()=>{o?D&&i&&i(!1):K.current&&(K.current=!1,F(!1),N?.(),oe(),ve(!1),ae(!1),xe(!1))},[o,D,i,oe,ve,ae,xe,N]),ue=L=>{O.current=L.touches[0].clientX,ee.current=L.touches[0].clientY},we=L=>{if(O.current===null||ee.current===null)return;const X=L.changedTouches[0].clientX,J=L.changedTouches[0].clientY,Z=O.current-X,Se=ee.current-J;Math.abs(Z)>Math.abs(Se)&&Math.abs(Z)>50&&(s==="left"&&Z>0&&pe(),s==="right"&&Z<0&&pe()),O.current=null,ee.current=null};return e.jsxs("div",{className:(j?j+" ":"")+"staggered-menu-wrapper"+(I?" fixed-wrapper":""),style:R?{"--sm-accent":R}:void 0,"data-position":s,"data-open":D||void 0,children:[D&&E&&e.jsx("div",{className:"sm-backdrop",onClick:()=>pe(),style:{position:"absolute",inset:0,zIndex:5,pointerEvents:"auto"},"aria-hidden":"true"}),e.jsx("div",{ref:A,className:"sm-prelayers","aria-hidden":"true",children:(()=>{let X=[...u&&u.length?u.slice(0,4):["#1e1e22","#35353c"]];if(X.length>=3){const J=Math.floor(X.length/2);X.splice(J,1)}return X.map((J,Z)=>e.jsx("div",{className:"sm-prelayer",style:{background:J}},Z))})()}),e.jsxs("header",{className:"staggered-menu-header","aria-label":"Main navigation header",children:[e.jsx("div",{className:"sm-logo","aria-label":"Logo",children:v?e.jsx("img",{src:v,alt:"Logo",className:"sm-logo-img",draggable:!1,width:110,height:24}):null}),e.jsxs("button",{ref:$,className:"sm-toggle","aria-label":D?"Close menu":"Open menu","aria-expanded":D,"aria-controls":"staggered-menu-panel",onClick:ce,type:"button",children:[e.jsx("span",{ref:c,className:"sm-toggle-textWrap","aria-hidden":"true",children:e.jsx("span",{ref:d,className:"sm-toggle-textInner",children:a.map((L,X)=>e.jsx("span",{className:"sm-toggle-line",children:L},X))})}),e.jsxs("span",{ref:W,className:"sm-icon","aria-hidden":"true",children:[e.jsx("span",{ref:M,className:"sm-icon-line"}),e.jsx("span",{ref:q,className:"sm-icon-line sm-icon-line-v"})]})]})]}),e.jsx("aside",{id:"staggered-menu-panel",ref:H,className:"staggered-menu-panel","aria-hidden":!D,onTouchStart:ue,onTouchEnd:we,children:e.jsx("div",{className:"sm-panel-inner",children:e.jsx("ul",{className:"sm-panel-list",role:"list","data-numbering":y||void 0,children:h&&h.length?h.map((L,X)=>e.jsx("li",{className:"sm-panel-itemWrap",children:e.jsx("a",{className:"sm-panel-item",href:"#",onClick:J=>{J.preventDefault(),n&&n(L.id)},"aria-label":L.ariaLabel,"data-index":X+1,children:e.jsx("span",{className:"sm-panel-itemLabel",children:L.label})})},L.label+X)):e.jsx("li",{className:"sm-panel-itemWrap","aria-hidden":"true",children:e.jsx("span",{className:"sm-panel-item",children:e.jsx("span",{className:"sm-panel-itemLabel",children:"No items"})})})})})})]})};function ks({children:n,className:t="",onClick:i,mouseX:s,spring:u,distance:h,magnification:S,baseItemSize:C}){const y=l.useRef(null),j=Ve(0),v=tt(s,R=>{if(!y.current)return 1/0;const k=y.current.getBoundingClientRect(),I=k.x+k.width/2;return Math.abs(R-I)}),P=tt(v,[0,h],[S,C]),b=it(P,u);return e.jsx(te.div,{ref:y,style:{width:b,height:b,minWidth:b,minHeight:b},onHoverStart:()=>j.set(1),onHoverEnd:()=>j.set(0),onClick:i,className:`dock-item ${t}`,"aria-haspopup":"true",children:l.Children.map(n,R=>l.cloneElement(R,{isHovered:j}))})}function Ts({children:n,className:t="",...i}){const{isHovered:s}=i,[u,h]=l.useState(!1);return l.useEffect(()=>{const S=s.on("change",C=>{h(C===1)});return()=>S()},[s]),e.jsx(Te,{children:u&&e.jsx(te.div,{initial:{opacity:0,y:10,x:"-50%"},animate:{opacity:1,y:0,x:"-50%"},exit:{opacity:0,y:5,x:"-50%"},transition:{duration:.2},className:`dock-label ${t}`,role:"tooltip",style:{left:"50%",x:"-50%"},children:n})})}function _s({children:n,className:t=""}){return e.jsx("div",{className:`dock-icon ${t}`,children:n})}function Fs({items:n,className:t="",spring:i={mass:.1,stiffness:300,damping:20},magnification:s=70,distance:u=200,panelHeight:h=68,dockHeight:S=256,baseItemSize:C=50}){const y=Ve(1/0),j=Ve(0),v=l.useMemo(()=>Math.max(S,s+s/2+4),[s,S]),P=tt(j,[0,1],[h,v]),b=it(P,i);return e.jsx(te.div,{style:{height:b,scrollbarWidth:"none"},className:"dock-outer",children:e.jsx(te.div,{onMouseMove:({pageX:R})=>{j.set(1),y.set(R)},onMouseLeave:()=>{j.set(0),y.set(1/0)},className:`dock-panel ${t}`,style:{height:h},role:"toolbar","aria-label":"Application dock",children:n.map((R,k)=>e.jsxs(ks,{onClick:R.onClick,className:R.className,mouseX:y,spring:i,distance:u,magnification:s,baseItemSize:C,children:[e.jsx(_s,{children:R.icon}),e.jsx(Ts,{children:R.label})]},k))})})}const Ms=()=>{const{activeTrail:n}=Ue(),t=Ve(-100),i=Ve(-100),s={damping:25,stiffness:70,mass:1},u=it(t,s),h=it(i,s);l.useEffect(()=>{const C=y=>{t.set(y.clientX),i.set(y.clientY)};return window.addEventListener("mousemove",C),()=>window.removeEventListener("mousemove",C)},[t,i]);const S={"apple-cat":Li,"jump-cat":Pi,"rolling-cat":Ei,duck:ki,pompom:Ti,"skeleton-run":_i,ghost:null};return!n||n==="none"?null:e.jsx("div",{style:{position:"fixed",top:0,left:0,pointerEvents:"none",zIndex:9999},children:S[n]?e.jsx(te.img,{src:S[n],alt:"trail",style:{x:u,y:h,translateX:25,translateY:25,width:"70px",height:"auto",filter:"drop-shadow(0 4px 6px rgba(0,0,0,0.3))"}}):n==="ghost"?e.jsx(te.div,{style:{x:u,y:h,translateX:20,translateY:20,fontSize:"2rem",filter:"drop-shadow(0 0 10px rgba(255,255,255,0.5))"},children:"👻"}):null})},ci=["Alineando las estrellas...","Despertando a los gatos...","Cargando recuerdos...","Preparando el universo..."],Is=({progress:n})=>{const[t,i]=l.useState(0);return l.useEffect(()=>{const s=setInterval(()=>{i(u=>(u+1)%ci.length)},1500);return()=>clearInterval(s)},[]),e.jsxs(te.div,{className:"loading-screen",exit:{opacity:0,pointerEvents:"none",transition:{duration:.8,ease:"easeInOut"}},children:[e.jsx("div",{className:"loading-background-effect"}),e.jsxs("div",{className:"loading-content",children:[e.jsx("h1",{className:"loading-title",children:"ONLY YOU"}),e.jsxs("div",{className:"progress-wrapper",children:[e.jsxs("div",{className:"progress-info",children:[e.jsx("span",{className:"loading-label",children:"Cargando sistema"}),e.jsxs("span",{className:"loading-percent",children:[n,"%"]})]}),e.jsx("div",{className:"progress-bar-bg",children:e.jsx(te.div,{className:"progress-bar-fill",initial:{width:0},animate:{width:`${n}%`},transition:{type:"spring",stiffness:50,damping:15}})})]}),e.jsx("div",{className:"message-container",children:e.jsx(te.div,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},exit:{opacity:0,y:-5},transition:{duration:.3},className:"loading-message",children:ci[t]},t)})]})]})},Ds=""+new URL("For You I'll Die - JAY SAV-BGIKD8t9.mp3",import.meta.url).href,zs=Object.freeze(Object.defineProperty({__proto__:null,default:Ds},Symbol.toStringTag,{value:"Module"})),Ns=""+new URL("From The Start (Sped Up) - Laufey-D4ysqUTI.mp3",import.meta.url).href,Us=Object.freeze(Object.defineProperty({__proto__:null,default:Ns},Symbol.toStringTag,{value:"Module"})),Os=""+new URL("I Really Want to Stay At Your House - Rosa Walton-BKlM1ya2.mp3",import.meta.url).href,Bs=Object.freeze(Object.defineProperty({__proto__:null,default:Os},Symbol.toStringTag,{value:"Module"})),Gs=""+new URL("La cena - Las Petunias-BzZvyMnw.mp3",import.meta.url).href,qs=Object.freeze(Object.defineProperty({__proto__:null,default:Gs},Symbol.toStringTag,{value:"Module"})),Ws=""+new URL("Let You Down - Dawid Podsiadło-CMbNZyx7.mp3",import.meta.url).href,Ys=Object.freeze(Object.defineProperty({__proto__:null,default:Ws},Symbol.toStringTag,{value:"Module"})),Xs=""+new URL("Tek It - Cafuné-DeWKFaBa.mp3",import.meta.url).href,Hs=Object.freeze(Object.defineProperty({__proto__:null,default:Xs},Symbol.toStringTag,{value:"Module"})),Vs=""+new URL("You and I - d4vd -DLXjY2fT.mp3",import.meta.url).href,$s=Object.freeze(Object.defineProperty({__proto__:null,default:Vs},Symbol.toStringTag,{value:"Module"})),Js=""+new URL("gourmet - rickyedit-u4-Lg7PG.mp3",import.meta.url).href,Ks=Object.freeze(Object.defineProperty({__proto__:null,default:Js},Symbol.toStringTag,{value:"Module"})),Qs=""+new URL("una manera perfecta de morir - INTERROGACIÓN AMOR-Bn3KiH1Y.mp3",import.meta.url).href,Zs=Object.freeze(Object.defineProperty({__proto__:null,default:Qs},Symbol.toStringTag,{value:"Module"})),ui=Object.assign({"../../assets/songs/For You I'll Die - JAY SAV.mp3":zs,"../../assets/songs/From The Start (Sped Up) - Laufey.mp3":Us,"../../assets/songs/I Really Want to Stay At Your House - Rosa Walton.mp3":Bs,"../../assets/songs/La cena - Las Petunias.mp3":qs,"../../assets/songs/Let You Down - Dawid Podsiadło.mp3":Ys,"../../assets/songs/Tek It - Cafuné.mp3":Hs,"../../assets/songs/You and I - d4vd .mp3":$s,"../../assets/songs/gourmet - rickyedit.mp3":Ks,"../../assets/songs/una manera perfecta de morir - INTERROGACIÓN AMOR.mp3":Zs}),ot=Object.keys(ui).map(n=>({title:n.split("/").pop().split(".")[0].replace(/-/g," ").replace(/\b\w/g,s=>s.toUpperCase()),artist:"Only U Playlist",src:ui[n].default}));ot.length===0&&ot.push({title:"No Songs Found",artist:"Add mp3 to assets/songs",src:""});const er=.1,tr=({visible:n,onClose:t})=>{const i=l.useRef(null),s=l.useRef(null),[u,h]=l.useState(!1),[S,C]=l.useState(0),[y,j]=l.useState(.3),[v,P]=l.useState(!1),[b,R]=l.useState(!1),[k,I]=l.useState(!1),[E,T]=l.useState(0),[N,U]=l.useState(0),F=ot[S];l.useEffect(()=>{i.current&&(i.current.volume=v?0:Math.pow(y,2)*er)},[y,v]),l.useEffect(()=>{u&&i.current&&i.current.play().catch(M=>console.log("Autoplay blocked",M))},[S]),l.useEffect(()=>{n||(R(!1),I(!1))},[n]),l.useEffect(()=>{const M=q=>{n&&(s.current&&s.current.contains(q.target)||q.target.closest(".dock-outer")||t&&t())};return document.addEventListener("mousedown",M),()=>document.removeEventListener("mousedown",M)},[n,t]);const o=()=>{i.current&&(T(i.current.currentTime),U(i.current.duration||0))},D=M=>{const q=parseFloat(M.target.value);T(q),i.current&&(i.current.currentTime=q)},K=()=>{u?i.current.pause():i.current.play(),h(!u)},H=()=>{C(M=>(M+1)%ot.length)},A=M=>{C(M),h(!0),I(!1)},V=M=>{if(!M||isNaN(M))return"0:00";const q=Math.floor(M/60),W=Math.floor(M%60);return`${q}:${W<10?"0":""}${W}`};return e.jsxs(te.div,{ref:s,className:"music-player-container",initial:"hidden",animate:n?"visible":"hidden",variants:{visible:{opacity:1,y:0,scale:1,pointerEvents:"auto"},hidden:{opacity:0,y:50,scale:.95,pointerEvents:"none"}},transition:{type:"spring",stiffness:300,damping:30},children:[e.jsx("audio",{ref:i,src:F.src,onEnded:H,onTimeUpdate:o,onLoadedMetadata:o,preload:"auto"}),e.jsx(Te,{children:k&&e.jsx(te.div,{className:"playlist-popup",initial:{opacity:0,y:10,scale:.95,x:"-50%"},animate:{opacity:1,y:0,scale:1,x:"-50%"},exit:{opacity:0,y:10,scale:.95,x:"-50%"},transition:{duration:.2},children:ot.map((M,q)=>e.jsxs("div",{className:`playlist-item ${q===S?"active":""}`,onClick:()=>A(q),children:[q+1,". ",M.title]},q))})}),e.jsx("div",{className:"compact-info",onClick:()=>I(!k),children:e.jsxs("div",{className:"song-title-wrapper",style:{display:"flex",alignItems:"center"},children:[e.jsx("span",{className:"song-title",children:F.title}),e.jsx(kn,{size:14,style:{minWidth:14,marginLeft:8,opacity:.6}})]})}),e.jsxs("div",{className:"compact-controls-row",children:[e.jsx("button",{className:"mini-play-btn",onClick:K,children:u?e.jsx(Tn,{size:16}):e.jsx(_n,{size:16,style:{marginLeft:"2px"}})}),e.jsxs("div",{className:"seek-bar-container",children:[e.jsx("input",{type:"range",min:"0",max:N,value:E,onChange:D,className:"seek-slider"}),e.jsxs("div",{className:"time-display",children:[V(E)," / ",V(N)]})]}),e.jsx("button",{className:"icon-btn",onClick:H,children:e.jsx(Fn,{size:18})}),e.jsxs("div",{className:"volume-wrapper",children:[e.jsx("button",{className:`icon-btn ${b?"active":""}`,onClick:()=>R(!b),children:v||y===0?e.jsx(Mn,{size:18}):e.jsx(yi,{size:18})}),e.jsx(Te,{children:b&&e.jsx(te.div,{className:"volume-popup",initial:{opacity:0,scale:.8,x:10},animate:{opacity:1,scale:1,x:0},exit:{opacity:0,scale:.8,x:0},children:e.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:v?0:y,onChange:M=>j(parseFloat(M.target.value))})})})]})]})]})},ir=({goldShopEnabled:n,setGoldShopEnabled:t,onTogglePrestige:i})=>{const[s,u]=l.useState(!1),[h,S]=l.useState(!1),[C,y]=l.useState(!1),j=l.useRef(null),{gameVolume:v,setGameVolume:P,resetProgress:b,achievements:R,ownedItems:k,activeCursor:I,addCoins:E,unlockAchievement:T}=Ue(),[N,U]=l.useState(!1),F=R.includes("prestige"),o=R.includes("collector"),D=I==="cursor_prestige";l.useEffect(()=>{const A=V=>{j.current&&!j.current.contains(V.target)&&u(!1)};return s&&document.addEventListener("mousedown",A),()=>document.removeEventListener("mousedown",A)},[s]),l.useEffect(()=>{const A=()=>U(window.innerWidth<=768);return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[]);const K=()=>{window.confirm("¿Estás seguro de que quieres borrar todo tu progreso (monedas y compras)?")&&(b(),u(!1))},H=()=>{const A=window.prompt("Introduce código de administrador:");A&&(["KONAMI","ADMIN","MATRIX"].includes(A.toUpperCase())?(E(1e6),T("matrix_master"),alert("¡Acceso concedido! Recursos añadidos."),u(!1)):alert("Código inválido."))};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        @media (max-width: 768px) {
          .settings-container {
      ...
      `}),e.jsxs("div",{className:"settings-container",ref:j,children:[e.jsx("button",{className:`settings-btn ${s?"active":""}`,onClick:()=>u(!s),"aria-label":"Ajustes",children:e.jsx(In,{size:20})}),e.jsx(Te,{children:s&&e.jsxs(te.div,{className:"settings-dropdown",initial:{opacity:0,y:-10,scale:.95},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-10,scale:.95},transition:{duration:.2},children:[e.jsxs("div",{style:{marginBottom:"15px",display:"flex",flexDirection:"column",gap:"12px"},children:[e.jsx(di,{label:"Cursor Prestigio",isActive:D,isLocked:!F,onToggle:()=>i(!D),color:"#f700ff"}),e.jsx(di,{label:"Tienda Dorada",isActive:n,isLocked:!o,onToggle:()=>t(!n),color:"#ffd700"})]}),e.jsxs("div",{className:"setting-item",children:[e.jsxs("div",{className:"label",children:[e.jsx(yi,{})," ",e.jsx("span",{children:"Sonido Juego"})]}),e.jsx("input",{type:"range",min:"0",max:"1",step:"0.1",value:v,onChange:A=>P(parseFloat(A.target.value))})]}),e.jsx("div",{className:"divider"}),e.jsxs("button",{className:"setting-action-btn",onClick:()=>{y(!0),u(!1)},children:[e.jsx(vt,{})," Logros"]}),e.jsxs("button",{className:"setting-action-btn",onClick:()=>{S(!0),u(!1)},children:[e.jsx(Dn,{})," Documentación"]}),N&&e.jsxs("button",{className:"setting-action-btn",onClick:H,children:[e.jsx(zn,{})," Código Admin"]}),e.jsxs("button",{className:"setting-action-btn danger",onClick:K,children:[e.jsx(Nn,{})," Resetear Progreso"]})]})})]}),e.jsx(Te,{children:h&&e.jsx("div",{className:"doc-overlay",onClick:()=>S(!1),children:e.jsxs(te.div,{className:"doc-modal",onClick:A=>A.stopPropagation(),initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},children:[e.jsx("button",{className:"close-doc-btn",onClick:()=>S(!1),children:e.jsx(xt,{size:24})}),e.jsx("h2",{children:"Mecánicas del Juego"}),e.jsxs("div",{className:"doc-content",children:[e.jsx("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}),e.jsx("p",{children:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}),e.jsxs("p",{children:[e.jsx("strong",{children:"Monedas:"})," Haz click en las monedas flotantes para recolectarlas. Las monedas especiales (brillantes) valen más puntos."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Tienda:"})," Usa tus monedas para desbloquear nuevos fondos, cursores y skins para las monedas."]})]})]})})}),e.jsx(Te,{children:C&&e.jsx("div",{className:"doc-overlay",onClick:()=>y(!1),children:e.jsxs(te.div,{className:"doc-modal",onClick:A=>A.stopPropagation(),initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},children:[e.jsx("button",{className:"close-doc-btn",onClick:()=>y(!1),children:e.jsx(xt,{size:24})}),e.jsxs("h2",{children:[e.jsx(vt,{style:{marginRight:"10px",color:"#ffd700"}})," ","Tus Logros"]}),e.jsx("div",{className:"doc-content",children:e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"15px"},children:Object.entries(rt).map(([A,V])=>{const M=R.includes(A);let q=V.desc;if(A==="collector"){const W=Object.values(yt).flat().filter(a=>a.type!=="skin"),d=W.length,c=k?W.filter(a=>k.includes(a.id)).length:0;q=`${V.desc} (${c}/${d})`}if(A==="prestige"){const d=Object.keys(rt).filter(a=>a!=="prestige"),c=R.filter(a=>d.includes(a)).length;q=`${V.desc} (${c}/${d.length})`}return e.jsxs("div",{style:{background:M?"rgba(255, 215, 0, 0.1)":"rgba(255, 255, 255, 0.05)",border:M?"1px solid rgba(255, 215, 0, 0.3)":"1px solid rgba(255, 255, 255, 0.1)",padding:"15px",borderRadius:"12px",opacity:M?1:.5,display:"flex",alignItems:"center",gap:"15px"},children:[e.jsx("div",{style:{fontSize:"2rem"},children:M?V.icon:e.jsx(bi,{className:"locked-icon"})}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:"0 0 5px 0",color:M?"#ffd700":"white"},children:V.title}),e.jsx("p",{style:{margin:0,fontSize:"0.9rem",color:"rgba(255,255,255,0.7)"},children:q})]})]},A)})})})]})})})]})},di=({label:n,isActive:t,isLocked:i,onToggle:s,color:u})=>e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",opacity:i?.5:1},children:[e.jsxs("span",{style:{fontSize:"0.9rem",fontWeight:500,display:"flex",alignItems:"center",gap:"8px",color:"white"},children:[n," ",i&&e.jsx(bi,{size:10,style:{opacity:.7}})]}),e.jsx("div",{onClick:i?void 0:s,style:{width:"40px",height:"22px",background:t?u:"rgba(255,255,255,0.2)",borderRadius:"12px",position:"relative",cursor:i?"not-allowed":"pointer",transition:"background 0.3s ease"},children:e.jsx(te.div,{animate:{x:t?18:2},transition:{type:"spring",stiffness:500,damping:30},style:{width:"18px",height:"18px",background:"white",borderRadius:"50%",position:"absolute",top:"2px",boxShadow:"0 2px 5px rgba(0,0,0,0.2)"}})})]}),nr=()=>{const{notification:n,clearNotification:t}=Ue();l.useEffect(()=>{if(n){const u=setTimeout(()=>{t()},4e3);return()=>clearTimeout(u)}},[n,t]);const i=n&&n.type==="achievement",s=i?rt[n.id]:null;return e.jsx(Te,{children:i&&s&&e.jsxs(te.div,{className:"achievement-toast",initial:{y:-100,x:"-50%",opacity:0},animate:{y:20,x:"-50%",opacity:1},exit:{y:-100,x:"-50%",opacity:0},transition:{type:"spring",stiffness:300,damping:20},children:[e.jsx("div",{className:"icon-container",children:e.jsx(hi,{size:24,color:"#ffd700"})}),e.jsxs("div",{className:"text-container",children:[e.jsx("span",{className:"title",children:"¡Logro Desbloqueado!"}),e.jsxs("span",{className:"name",children:[s.icon," ",s.title]}),e.jsx("span",{className:"desc",children:s.desc})]})]})})},or=[{id:"backgrounds",label:"Fondos",ariaLabel:"Galería de Fondos"},{id:"cursors",label:"Cursores",ariaLabel:"Personalizar Cursor"},{id:"trails",label:"Mascotas",ariaLabel:"Personalizar Mascota"},{id:"skins",label:"Monedas",ariaLabel:"Personalizar Monedas"}];function sr(){const{isUnlocked:n,openShop:t,closeShop:i,lockGame:s,activeBackground:u,toggleGame:h,isGameActive:S,activeShop:C,addCoins:y,unlockAchievement:j,achievements:v,setCursor:P,activeCursor:b}=Ue(),[R,k]=l.useState(!0),[I,E]=l.useState(!1),[T,N]=l.useState(!1),[U,F]=l.useState(!1),[o,D]=l.useState(!0),[K,H]=l.useState(!1),[A,V]=l.useState(null),[M,q]=l.useState(null),[W,d]=l.useState(null),[c,a]=l.useState(null),[p,m]=l.useState(null),[w,B]=l.useState(null),[Y,re]=l.useState(null),[$,ie]=l.useState(null);l.useEffect(()=>{const L=(X,J)=>{let Z=document.querySelector(`meta[name="${X}"]`);Z||(Z=document.createElement("meta"),Z.name=X,document.head.appendChild(Z)),Z.setAttribute("content",J)};L("viewport","width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, viewport-fit=cover"),L("apple-mobile-web-app-capable","yes"),L("apple-mobile-web-app-status-bar-style","black-translucent")},[]);const[ne,O]=l.useState(!0),[ee,le]=l.useState("default"),z=L=>{L?(b!=="cursor_prestige"&&le(b),P("cursor_prestige")):P(ee||"default")};l.useEffect(()=>{n&&v&&!v.includes("prestige")&&Object.keys(rt).filter(Z=>Z!=="prestige").every(Z=>v.includes(Z))&&(j("prestige"),P&&P("cursor_prestige"))},[v,n,j,P]);const oe=l.useRef(0);l.useEffect(()=>{if(!n)return;const L=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a"],X=J=>{const Z=J.key.toLowerCase(),Se=L[oe.current].toLowerCase();Z===Se?(oe.current++,oe.current===L.length&&(y(1e6),j("matrix_master"),console.log("CHEAT ACTIVATED: KONAMI CODE!"),oe.current=0)):(oe.current=0,Z===L[0].toLowerCase()&&(oe.current=1))};return window.addEventListener("keydown",X),()=>window.removeEventListener("keydown",X)},[n,y,j]);const ve=L=>{L&&t(L)},ae=()=>{T?(N(!1),U&&k(!0)):(H(!1),i(),F(R),k(!1),N(!0))},xe=[{icon:e.jsx(Un,{size:22}),label:"Texto",onClick:()=>{i(),S?h():k(!R)}},{icon:e.jsx(On,{size:22}),label:"Música",onClick:()=>{i(),E(!I)}},{icon:e.jsx(Bn,{size:22}),label:"Tienda",onClick:()=>{C&&i(),H(!K)}},{icon:e.jsx(Gn,{size:22,color:S?"#f700ff":"currentColor"}),label:"Juego",onClick:()=>{i(),S?k(o):(D(R),k(!0)),h()}},{icon:e.jsx(qn,{size:22}),label:"Fondo",onClick:ae},{icon:e.jsx(Wn,{size:22}),label:"Bloquear",onClick:()=>{s&&(i(),E(!1),V(null),q(null),d(null),a(null),m(null),B(null),re(null),ie(null),s())}}],[ce,pe]=l.useState(!0),[ue,we]=l.useState(0);return l.useEffect(()=>{const L=setInterval(()=>{we(X=>{const J=X+Math.floor(Math.random()*15)+5;return J>=100?(clearInterval(L),setTimeout(()=>pe(!1),200),100):J})},200);return()=>clearInterval(L)},[]),e.jsxs("main",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden"},children:[e.jsx(Te,{mode:"wait",children:ce&&e.jsx(Is,{progress:ue},"loader")}),e.jsx(Te,{children:!n&&e.jsx(te.div,{initial:{opacity:0,filter:"blur(20px)",scale:1.1},animate:{opacity:1,filter:"blur(0px)",scale:1},exit:{opacity:0,filter:"blur(20px)",scale:1.1,transition:{duration:2}},transition:{duration:2,ease:"easeInOut"},style:{position:"fixed",zIndex:9999,inset:0,background:"#000"},children:e.jsx(eo,{})},"lock-screen")}),e.jsx(Te,{children:n&&e.jsxs(te.div,{className:"app-content",initial:{opacity:0,scale:.95,filter:"blur(10px)"},animate:{opacity:1,scale:1,filter:"blur(0px)"},exit:{opacity:0,scale:1.1,filter:"blur(10px)",transition:{duration:1}},transition:{duration:1},style:{width:"100%",height:"100%",position:"relative",overflow:"hidden"},children:[e.jsx(Ps,{floatingLinesConfig:A,lightPillarsConfig:M,ballpitConfig:W,silkConfig:c,galaxyConfig:p,gradientConfig:w,pixelSnowConfig:Y,hyperspeedConfig:$}),e.jsx(ir,{goldShopEnabled:ne,setGoldShopEnabled:O,onTogglePrestige:z}),e.jsx(nr,{}),e.jsx(Es,{isOpen:K,onToggle:L=>{H(L),L&&N(!1)},items:or,isFixed:!0,position:"right",onItemClick:ve,colors:["#f700ff","#bd71ff","#8629b1"],accentColor:"#f700ff",menuButtonColor:"#fff",openMenuButtonColor:"#ffffff",displayItemNumbering:!0,logoUrl:null}),e.jsx(qo,{}),e.jsx(Qo,{enableGoldTheme:ne}),e.jsx(Ms,{}),e.jsx(Te,{children:R&&e.jsx(te.div,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},transition:{duration:.3},style:{position:"absolute",width:"100%",height:"100%",zIndex:10},children:e.jsx(ts,{})})}),e.jsx(Te,{children:T&&["floatinglines","lightpillars","ballpit","silk","galaxy","gradient","pixelsnow","hyperspeed"].includes(u)&&e.jsx(te.div,{initial:{opacity:0,x:50},animate:{opacity:1,x:0},exit:{opacity:0,x:50},transition:{duration:.3},style:{position:"absolute",top:0,right:0,zIndex:200,height:"100%",pointerEvents:"auto"},children:e.jsx("div",{style:{height:"100%"},children:e.jsx(As,{onClose:ae,floatingLinesConfig:A,setFloatingLinesConfig:V,lightPillarsConfig:M,setLightPillarsConfig:q,ballpitConfig:W,setBallpitConfig:d,silkConfig:c,setSilkConfig:a,galaxyConfig:p,setGalaxyConfig:m,gradientConfig:w,setGradientConfig:B,pixelSnowConfig:Y,setPixelSnowConfig:re,hyperspeedConfig:$,setHyperspeedConfig:ie})})})}),e.jsx(tr,{visible:I,onClose:()=>E(!1)}),e.jsx(Fs,{items:xe,panelHeight:60,baseItemSize:45,magnification:60})]},"main-content")})]})}Yn.createRoot(document.getElementById("root")).render(e.jsx(l.StrictMode,{children:e.jsx(sr,{})}));
